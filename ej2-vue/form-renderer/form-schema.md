---
layout: post
title: Form Schema in Vue Form Renderer Component | Syncfusion
description: Learn here all about the JSON schema structure that drives the Syncfusion Vue Form Renderer component of Syncfusion Essential JS 2 and more.
control: Form Schema
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
...
# Form Schema in Vue Form Renderer component
