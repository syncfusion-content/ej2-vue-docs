---
layout: post
title: Form Actions in Vue Form Renderer Component | Syncfusion
description: Learn here all about Form Actions in Syncfusion Vue Form Renderer control of Syncfusion Essential JS 2 and more.
...
# Form Actions in Vue Form Renderer component
...
```html
<template>
  <ejs-formrenderer :schema="schema"></ejs-formrenderer>
</template>
...
```html
<template>
  <ejs-formrenderer :schema="schema" :buttonClick="onButtonClick"></ejs-formrenderer>
</template>
...
```html
<template>
  <ejs-formrenderer :schema="schema" :change="onChange"></ejs-formrenderer>
</template>
...
```html
<template>
  <ejs-formrenderer :schema="schema" :created="onCreated"></ejs-formrenderer>
</template>
