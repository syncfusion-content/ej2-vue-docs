...
Install [Syncfusion<sup style="font-size:70%">&reg;</sup> Vue components skills](https://github.com/syncfusion/vue-ui-components-skills.git) using the Skills CLI. Users can also explore available skills from the [marketplace](https://www.skills.sh/syncfusion).
