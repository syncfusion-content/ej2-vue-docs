...
```
GraphQLAdaptor/
├── GraphQLAdaptor.client/            # Vue frontend (Vite + Vue project)
│   ├── src/
│   │   ├── App.vue               # Add GraphQL Adaptor logic here
│   │   └── main.js               # Vue app entry point
│   ├── index.html
│   ├── package.json
│   └── vite.config.js
│
└── GraphQLAdaptor.Server/            # ASP.NET Core backend (API)
