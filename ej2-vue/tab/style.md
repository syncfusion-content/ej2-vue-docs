---
layout: post
title: Style in Vue Tabs | Syncfusion
description: Override default Vue Tabs CSS classes to customize the wrapper, header, items, and active tab appearance to match your application design.
control: Style 
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
