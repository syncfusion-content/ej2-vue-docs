---
layout: post
title: Vue 2 Getting Started with Vue Form Builder component | Syncfusion
description:  Checkout and learn about Getting Started with Vue Form Builder component of Syncfusion Essential JS 2 and more details.
...
# Getting Started with the Vue Form Builder Component in Vue 2

This article provides a step-by-step guide for setting up a Vue 2 project using [Vue CLI](https://cli.vuejs.org) and integrating the Syncfusion<sup style="font-size:70%">&reg;</sup> Vue Form Builder component.
...
## Add the Vue Form Builder package

To install the Form Builder package, use the following command:

{% tabs %}
{% highlight bash tabtitle="npm" %}
npm install @syncfusion/ej2-vue-form-builder --save
{% endhighlight %}
{% highlight bash tabtitle="yarn" %}
...
## Add the Vue Form Builder component
...
<script>
import { FormBuilderComponent, FormBuilderPlugin } from "@syncfusion/ej2-vue-form-builder";
import Vue from "vue";
