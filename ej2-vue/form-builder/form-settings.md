---
title: Form Settings Panel in Vue Form Builder control | Syncfusion
description: Learn how to use the Form Settings Panel in the Vue Form Builder control to customize the global settings for a form.
platform: ej2-vue
...
# Form Settings Panel in Vue Form Builder component
...
**Float Label Type** — Controls how field labels appear when you interact with input fields. This property applies to all supported components (like TextBox, TextArea, NumericTextBox, DropDownList, etc.).
