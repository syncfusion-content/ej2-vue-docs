---
layout: post
title: Field Components Panel in Vue Form Builder control | Syncfusion
description: Learn how to use the Field Components Panel in the Vue Form Builder control to create a form using the drag-and-drop interface.
platform: ej2-vue
...
# Field Components Panel in Vue Form Builder component
...
<template>
  <ejs-formbuilder :formTemplates="formTemplates" ref="formObj">
  </ejs-formbuilder>
</template>
...
<template>
  <ejs-formbuilder :toolboxCategories="toolBoxCategories" ref="formObj">
  </ejs-formbuilder>
</template>
...
import {
  ComponentCategory,
  FormWidgetType
} from "@syncfusion/ej2-form-builder";
