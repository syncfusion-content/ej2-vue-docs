---
layout: post
title: Getting Started with Vue AppBar | Syncfusion
...
This article provides a step-by-step guide for setting up a Vue 2 project using [Vue-CLI](https://cli.vuejs.org) and integrating the Syncfusion<sup style="font-size:70%">&reg;</sup> Vue Appbar component.
...
## Adding Vue Appbar packages

To install the Appbar package, use the following command:
...
The Appbar code should be added in the **src/App.vue** file.
