...
# Getting Started with Syncfusion AppBar Component in Vue 3 using Composition API
...
npm install
```
Now that `my-project` is ready to run with default settings, let's add Syncfusion AppBar component to the project.
