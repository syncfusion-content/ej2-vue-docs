...
## Add Vue AppBar packages

To install the AppBar packages, use the following command:
...
This example uses the Vue Button component. Install the `@syncfusion/ej2-vue-buttons` package by running the following command:
