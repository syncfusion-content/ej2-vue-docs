---
layout: post
title: Accessibility in Vue Chat UI | Syncfusion®
description: Learn how the Vue Chat UI meets WCAG 2.2, Section 508, and ADA accessibility standards with full screen reader and keyboard navigation support.
platform: ej2-vue
control: Chat UI
documentation: ug
domainurl: ##DomainURL##
