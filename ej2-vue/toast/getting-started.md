---
layout: post
title: Getting Started with Vue Toaster | Syncfusion
description: Learn how to get started with the Syncfusion Vue Toaster control. Explore setup, features, examples, and customization options.
...
# Getting Started with Vue Toaster
...
## Adding Vue Toast packages

To install the Toast package, use the following command:
