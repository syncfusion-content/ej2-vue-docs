...
To get start quickly with Vue DateTimePicker, you can check on this video:

{% youtube "https://www.youtube.com/watch?v=LlBIpQhiSCA" %}
...
## Adding Syncfusion DateTimePicker package in the application
 ...
 Syncfusion Vue packages are maintained in the [`npmjs.com`](https://www.npmjs.com/~syncfusionorg) registry. The DateTimePicker component will be used in this example. To install it use the following command.
...
Import the needed css styles for the DateTimePicker component along with dependency styles in the `<style>` section of the `src/App.vue` file as follows.
