...
To install the Splitter packages, use the following command:
...
<style>
@import "@syncfusion/ej2-material3-theme/styles/splitter/index.css";
</style>

{% endhighlight %}
{% endtabs %}

## Adding Vue Splitter component
