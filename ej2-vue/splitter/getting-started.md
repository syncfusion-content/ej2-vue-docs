---
layout: post
title: Getting Started with Vue Splitter | Syncfusion
description: Set up a Vue 2 project with Vue CLI and integrate the Syncfusion Vue Splitter component, including CSS themes and basic pane splitting in App.vue.
...
# Getting Started with Vue Splitter

This article provides a step-by-step guide for setting up a Vue 2 project using [Vue-CLI](https://cli.vuejs.org) and integrating the Syncfusion<sup style="font-size:70%">&reg;</sup> Vue Splitter component.
...
## Adding Vue Splitter packages

To install the Splitter package, use the following command:
...
The Splitter code should be added in the **src/App.vue** file.
