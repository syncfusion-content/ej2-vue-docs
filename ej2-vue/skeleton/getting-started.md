...
description: Learn how to get started with the Syncfusion Vue Skeleton control. Explore setup, features, examples, and customization options.
...
## Adding Vue Skeleton packages

To install the Skeleton package, use the following command:
...
The Skeleton code should be added in the **src/App.vue** file.
