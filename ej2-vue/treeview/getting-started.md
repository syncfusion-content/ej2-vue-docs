---
layout: post
title: Getting Started with Vue TreeView | Syncfusion
...
# Getting Started with Vue TreeView

This article provides a step-by-step guide for setting up a Vue 2 project using [Vue-CLI](https://cli.vuejs.org) and integrating the Syncfusion<sup style="font-size:70%">&reg;</sup> Vue TreeView component.
...
## Adding Vue TreeView packages

To install the TreeView package, use the following command:
