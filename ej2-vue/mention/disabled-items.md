---
layout: post
title: Disabled Items in Vue Mention | Syncfusion
description: Disable individual Syncfusion Vue Mention items by mapping the fields.disabled property, or use the disableItem method for runtime changes.
