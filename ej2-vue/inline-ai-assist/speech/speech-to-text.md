---
layout: post
title: Speech-to-Text in Vue Inline AI Assist | Syncfusion®
description: Enable Speech-to-Text in the Vue Inline AI Assist using the browser Web Speech API to convert microphone voice input into prompt text.
platform: ej2-vue
...
# Speech-to-Text in Vue Inline AI Assist

The Syncfusion Vue Inline AI Assist component integrates `Speech-to-Text` functionality through the browser's [Web Speech API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Speech_API). This enables the conversion of spoken words into text using the device's microphone, allowing users to interact with Inline AI Assist through voice input.

## Prerequisites

Before integrating `Speech-to-Text`, ensure the following:

1. The Syncfusion Inline AI Assist component is properly set up in your Vue application.
...
2. The Inline AI Assist component is integrated with [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-foundry/models/openai/).
	- [Integration of Azure OpenAI With Vue Inline AI Assist component](../ai-integrations/openai-integration)

## Enable built-in speech-to-text

You can enable speech-to-text support using the `:speech-to-text-settings` property. Set the `enable` property to `true` within the speechToTextSettings configuration to activate this feature.

{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/inline-ai-assist/speech/stt/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/inline-ai-assist/speech/stt/app.vue %}
{% endhighlight %}
{% endtabs %}
...
This example demonstrates how to set up Inline AI Assist with all these speech recognition features enabled:

{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/inline-ai-assist/speech/speech-configuration/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/inline-ai-assist/speech/speech-configuration/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/inline-ai-assist/speech/tooltip-settings/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/inline-ai-assist/speech/tooltip-settings/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/inline-ai-assist/speech/speech-events/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/inline-ai-assist/speech/speech-events/app.vue %}
{% endhighlight %}
{% endtabs %}
