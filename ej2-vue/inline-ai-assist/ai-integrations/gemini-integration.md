...
To integrate Gemini AI with the Syncfusion Inline AI Assist component in your application:
...
{% include code-snippet/inline-ai-assist/ai-integrations/gemini-ai/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/inline-ai-assist/ai-integrations/gemini-ai/app.vue %}
{% endhighlight %}
{% endtabs %}
