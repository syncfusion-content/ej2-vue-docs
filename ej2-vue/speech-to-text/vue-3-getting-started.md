...
This article provides a step-by-step guide for setting up a [Vite](https://vitejs.dev/) project with a JavaScript environment and integrating the Syncfusion Vue SpeechToText component using the [Composition API](https://vuejs.org/guide/introduction.html#composition-api) / [Options API](https://vuejs.org/guide/introduction.html#options-api).
...
## Adding Syncfusion SpeechToText package in the application

Syncfusion Vue packages are maintained in the [`npmjs.com`](https://www.npmjs.com/~syncfusionorg) registry. The SpeechToText component will be used in this example. To install it use the following command.
...
## Adding CSS reference for Syncfusion Vue SpeechToText component
...
## Adding Syncfusion Vue SpeechToText component in the application
