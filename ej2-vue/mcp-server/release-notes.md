...
description: Explore the release notes for Syncfusion Vue MCP Server, featuring Agentic UI Builder, 145+ components, theme integration, and AI-powered Vue development tools.
...
# Syncfusion Vue MCP Server Release Notes

This document provides information about the changes and new features included in each version of the [@syncfusion/vue-assistant](https://www.npmjs.com/package/@syncfusion/vue-assistant) MCP server package.
...
- Initial release of AI Coding Assistant for Syncfusion Vue components.
