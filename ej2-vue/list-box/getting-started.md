...
In this article, the `Material3` theme is applied using CSS styles, which are available in installed packages. The necessary `Material3` CSS styles for the ListBox component and its dependents were imported into the `<style>` section of the **src/App.vue** file.
...
Follow the below steps to add the Vue ListBox component:

1\. First, import and register the ListBox component in the `script` section of the **src/App.vue** file.
