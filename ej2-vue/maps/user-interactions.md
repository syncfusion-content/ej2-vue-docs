...
* [`border`](https://ej2.syncfusion.com/vue/documentation/api/maps/selectionSettingsModel#border) - To customize the color, width, and opacity of the border of the element that is selected in Maps.
...
* [`enableMultiSelect`](https://ej2.syncfusion.com/vue/documentation/api/maps/selectionSettingsModel#enablemultiselect) - To enable or disable the selection for multiple shapes, markers, or bubbles in the Maps.
...
Shapes can be initially selected when the Maps loads using the  [`initialShapeSelection`](https://ej2.syncfusion.com/vue/documentation/api/maps/initialShapeSelectionSettingsModel) property. The values are mapped to the [`shapePath`](https://ej2.syncfusion.com/vue/documentation/api/maps/initialShapeSelectionSettingsModel#shapepath) and [`shapeValue`](https://ej2.syncfusion.com/vue/documentation/api/maps/initialShapeSelectionSettingsModel#shapevalue) properties.
...
Using the [`initialMarkerSelection`](https://ej2.syncfusion.com/vue/documentation/api/maps/initialMarkerSelectionSettingsModel), property, markers can be selected initially when the Maps loads. Markers are rendered based on the  [`latitude`](https://ej2.syncfusion.com/vue/documentation/api/maps/initialMarkerSelectionSettingsModel#latitude) and [`longitude`](https://ej2.syncfusion.com/vue/documentation/api/maps/initialMarkerSelectionSettingsModel#longitude) values.
...
Each shape in the Maps can be highlighted during mouse hover or touch interactions. This feature applies to Maps elements such as shapes, bubbles, markers, and legends. Highlight is enabled by setting the [`enable`](https://ej2.syncfusion.com/vue/documentation/api/maps/highlightSettingsModel#enable) property of [`highlightSettings`](https://ej2.syncfusion.com/vue/documentation/api/maps/highlightSettingsModel) to **true**.
...
* [`border`](https://ej2.syncfusion.com/vue/documentation/api/maps/highlightSettingsModel#border) - To customize the color, width, and opacity of the border of the element that is highlighted in Maps.
* [`fill`](https://ej2.syncfusion.com/vue/documentation/api/maps/highlightSettingsModel#fill) - Applies the color for the element that is highlighted.
* [`opacity`](https://ej2.syncfusion.com/vue/documentation/api/maps/highlightSettingsModel#opacity) - To customize the transparency for the element that is highlighted.
...
On mouse over or touch end events, the tooltip is used to display additional information about the layer, bubble, or marker. Tooltips can be enabled separately for layers, bubbles, or markers by setting the [`visible`](https://ej2.syncfusion.com/vue/documentation/api/maps/tooltipSettingsModel#visible) property of [`tooltipSettings`](https://ej2.syncfusion.com/vue/documentation/api/maps/tooltipSettingsModel) to **true**. The [`valuePath`](https://ej2.syncfusion.com/vue/documentation/api/maps/tooltipSettingsModel#valuepath) property specifies the field name from the data source whose value is displayed as the tooltip text. The [`tooltipDisplayMode`](https://ej2.syncfusion.com/vue/documentation/api/maps/mapsModel#tooltipdisplaymode) property is used to change the display mode of the tooltip in Maps. The following display modes are available in the Maps component. By default, [`tooltipDisplayMode`](https://ej2.syncfusion.com/vue/documentation/api/maps/mapsModel#tooltipdisplaymode) is set to **MouseMove**.
