...
# Accessibility in Vue Maps component
...
To change this default description, use the [`description`](https://ej2.syncfusion.com/vue/documentation/api/maps/#description) property available in [`legendSettings`](https://ej2.syncfusion.com/vue/documentation/api/maps/commonTitleSettingsModel/#description), [`titleSettings`](https://ej2.syncfusion.com/vue/documentation/api/maps/titleSettingsModel/#description), [`subtitleSettings`](https://ej2.syncfusion.com/vue/documentation/api/maps/subTitleSettingsModel/#description) and [`Maps`](https://ej2.syncfusion.com/vue/documentation/api/maps/#description). It helps the screen reader to read for an assistive purpose.
