...
The following properties are available in the Linear Gauge to customize the Linear Gauge area.
...
The Linear Gauge component is rendered with margin by default. To remove the margin around the Linear Gauge, the [`allowMargin`](https://ej2.syncfusion.com/vue/documentation/api/linear-gauge#allowmargin) property in the Linear Gauge is set as **false**.
