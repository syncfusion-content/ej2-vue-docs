---
layout: post
title: Template in Vue Dialog | Syncfusion
description: Customize Vue Dialog header, content, and footer templates with text or HTML using the header, content, footerTemplate, and buttons properties.
control: Template 
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
