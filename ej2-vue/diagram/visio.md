...
{% include code-snippet/diagram/visioimportexport/visioImport-cs1/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/diagram/visioimportexport/visioImport-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/diagram/visioimportexport/visioExport-cs1/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/diagram/visioimportexport/visioExport-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}
