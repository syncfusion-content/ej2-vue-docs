---
layout: post
title: Vue 3 Getting Started with the Progress Button | Syncfusion
description: Set up a Vite Vue 3 project and integrate the Syncfusion Vue Progress Button using the Composition API or Options API.
...
# Vue 3 Getting Started with the Progress Button
