...
# Telemetry in Syncfusion® Vue Components
...
Telemetry applies only to the usage of Syncfusion<sup style="font-size:70%">&reg;</sup> Vue components during development.
...
Call `Telemetry.disable()` at application startup, before creating any Syncfusion<sup style="font-size:70%">&reg;</sup> Vue component instance.
