---
layout: post
title: Getting Started Vue 3 with Vue Context Menu | Syncfusion
...
# Getting Started with Vue Context Menu in Vue 3
...
## Add Vue Context Menu packages

To install the Context Menu packages, use the following command:
...
## Adding Vue Context Menu component

The Context Menu code should be added in the **src/App.vue** file.
...
<template>
<div>
     <ejs-contextmenu :items='menuItems'></ejs-contextmenu>
 </div>
</template>
