---
layout: post
title: Disabled Items in Vue ComboBox | Syncfusion
description: Disable individual Syncfusion Vue ComboBox items by mapping the fields.disabled property so users cannot select them as values.
...
# Disabled Items in Vue ComboBox
