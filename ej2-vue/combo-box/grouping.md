---
layout: post
title: Grouping in Vue ComboBox | Syncfusion
description: Group Syncfusion Vue ComboBox items into inline or fixed headers by mapping the groupBy field, with dynamic updates on scroll.
control: Grouping 
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
