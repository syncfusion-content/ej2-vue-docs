...
{% include code-snippet/ai-assistview/chain-of-thoughts/basic/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/chain-of-thoughts/basic/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/chain-of-thoughts/stages-status/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/chain-of-thoughts/stages-status/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/chain-of-thoughts/editable-context/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/chain-of-thoughts/editable-context/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/chain-of-thoughts/block-template/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/chain-of-thoughts/block-template/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/chain-of-thoughts/item-template/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/chain-of-thoughts/item-template/app.vue %}
{% endhighlight %}
{% endtabs %}
...
- [Prompt and response collection](../api/ai-assistview#prompt-response-collection)
- [Tool blocks](../api/ai-assistview#tool-blocks)
- [Streaming responses](../api/ai-assistview#streaming-responses)
- [addPromptResponse method](../api/ai-assistview#addpromptresponse)
