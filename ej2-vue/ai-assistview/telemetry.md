---
layout: post
title: Telemetry in Vue AI AssistView | Syncfusion®
description: Track AI interaction metrics such as duration, tool calls, and token usage with the Syncfusion® Vue AI AssistView telemetry.
platform: ej2-vue
...
# Telemetry in Vue AI AssistView
...
{% include code-snippet/ai-assistview/telemetry/getting-started/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/telemetry/getting-started/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/telemetry/metrics/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/telemetry/metrics/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/telemetry/before-report/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/telemetry/before-report/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/telemetry/usage-data/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/telemetry/usage-data/app.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/telemetry/custom-attributes/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/ai-assistview/telemetry/custom-attributes/app.vue %}
{% endhighlight %}
{% endtabs %}
