---
layout: post
title: Mentions in Vue AI AssistView | Syncfusion®
description: Render mentions in the Syncfusion® Vue AI AssistView prompt editor by configuring the trigger character, data source, filtering, popup, and templates.
platform: ej2-vue
...
Use the [`mentions`](../api/ai-assistview#mentions) property to configure the trigger character, data source, field mappings, filtering behavior, popup dimensions, and templates.
...
{% include code-snippet/ai-assistview/mentions/basic/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/basic/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/ai-assistview/mentions/mention-char/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/mention-char/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/ai-assistview/mentions/data-source/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/data-source/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/ai-assistview/mentions/fields/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/fields/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/ai-assistview/mentions/query/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/query/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/ai-assistview/mentions/filter-type/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/filter-type/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/ai-assistview/mentions/highlight/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/highlight/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/ai-assistview/mentions/show-mention-char/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/show-mention-char/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/ai-assistview/mentions/display-template/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/display-template/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/ai-assistview/mentions/popup-size/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/popup-size/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/ai-assistview/mentions/item-template/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/item-template/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/ai-assistview/mentions/no-records-template/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/no-records-template/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="app.vue" %}
{% include code-snippet/ai-assistview/mentions/mention-select/app.vue %}
{% endhighlight %}
{% highlight html tabtitle="app-composition.vue" %}
{% include code-snippet/ai-assistview/mentions/mention-select/app-composition.vue %}
{% endhighlight %}
{% endtabs %}
