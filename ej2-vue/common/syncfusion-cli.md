...
For Vue development, the Syncfusion<sup style="font-size:70%">&reg;</sup> CLI supports project creation with **Vite**. By using the Syncfusion<sup style="font-size:70%">&reg;</sup> CLI, developers can reduce manual configuration effort and quickly start building Vue projects with a recommended project structure, predefined templates, and the required component setup.
...
- **Project Scaffolding** - Quickly create Vue projects with the required Syncfusion configuration and recommended project structure.
- **Component Templates** - Start with ready-to-use Vue component templates such as `Grid`, `Chart`, `Scheduler`, `Gantt`, `File Manager`, `Diagram`, and `Rich Text Editor`, `PDF Viewer`, `DOCX Editor` and `Spreadsheet Editor`.
...
- **AI Assistant Integration** - Configure MCP assistants and install Syncfusion<sup style="font-size:70%">&reg;</sup> components Skills to improve AI-assisted Vue development.
...
<td>Creates a new Vue project using Syncfusion Vue components.</td>
<td>sf new</td>
</tr>
<tr>
<td>Add component to existing project</td>
<td>Adds a Syncfusion Vue component to an existing project.</td>
<td>sf add</td>
</tr>
<tr>
...
The following example uses the `new` command to create a Vue project with Syncfusion<sup style="font-size:70%">&reg;</sup> Vue components using the Grid template and Material 3 theme.

{% tabs %}
{% highlight bash tabtitle="CMD" %}
sf new my-app --framework vue --template grid
{% endhighlight %}
{% endtabs %}.
...
Create a new Syncfusion<sup style="font-size:70%">®</sup> project with the desired framework, build tool, templates, themes, and other configuration options. The project creation commands help you quickly set up a development environment and start building applications with Syncfusion components.

#### `new` command
  
The `new` command creates a Vue project with Syncfusion<sup style="font-size:70%">&reg;</sup> Vue components. You can use this command to specify the framework, build tool, project type, component template, theme, styling format, MCP assistant configuration, and component skills installation.

#### Syntax
  
{% tabs %}
{% highlight bash tabtitle="CMD" %}
sf new <project-name> --framework <framework> --type <type> --template <component> --theme <theme> --styling <styling> --mcp <editor> --skills
{% endhighlight %}
{% endtabs %}

#### Example
  
The following command creates a Vue application using Vite with JavaScript, Grid template, Tailwind 3 theme, CSS styling, Syncfusion<sup style="font-size:70%">&reg;</sup> Code Studio MCP configuration, and skills installation.

{% tabs %}
{% highlight bash tabtitle="CMD" %}
sf new my-app --framework vue --template grid --theme tailwind3 --mcp code-studio --skills
{% endhighlight %}
{% endtabs %}
...
<td><code>vue</code>, <code>react</code>, <code>angular</code></td>
</tr>
<tr>
<td><code>--type</code></td>
<td>Specifies the application language.</td>
...
The Syncfusion CLI supports Vue, React, and Angular applications.
