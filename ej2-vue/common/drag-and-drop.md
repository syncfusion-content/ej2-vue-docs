---
layout: post
title: Drag And Drop in Vue Components | Syncfusion
description: Learn how to enable drag-and-drop interactions in Syncfusion Vue components using Draggable and Droppable utilities.
control: Common
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
...
# Drag And Drop in Syncfusion® Vue Components
