...
The following table lists the Syncfusion<sup style="font-size:70%">&reg;</sup> Vue components that support state persistence and the properties stored in `localStorage`.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        ColorPicker, ListBox, In-place Editor, RichTextEditor,<br>
