---
layout: post
title: Getting Started with Vue Button | Syncfusion
description: Learn how to get started with the Syncfusion Vue Button control. Explore setup, features, examples, and customization options.
...
# Getting Started with Vue Button
...
## Adding Vue Button packages

To install the Button package, use the following command:
...
The Button code should be added in the **src/App.vue** file.
