---
layout: post
title: Vue 3 getting started with the Button component | Syncfusion
description: Check out and learn about Vue 3 getting started with the Vue Button component of Syncfusion Essential JS 2 and more details.
...
This article uses the [Vue Button component](https://www.syncfusion.com/vue-components/vue-button) as an example. To use the Vue Button component in the project, the `@syncfusion/ej2-vue-buttons` package needs to be installed using the following command:
...
In this article, `Material3` theme is applied using CSS styles, which are available in installed packages. The necessary `Material3` CSS styles for the Button component and its dependencies were imported into the `<style>` section of **src/App.vue** file.
...
![vue-3-js-button](images/vue-3-js-button.PNG)
