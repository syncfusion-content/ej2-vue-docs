...
description: Learn how to get started with the Syncfusion Vue Message control using Vite and the Composition API in a Vue 3 project.
...
## Add Vue Message packages

To install the Message packages, use the following command:
