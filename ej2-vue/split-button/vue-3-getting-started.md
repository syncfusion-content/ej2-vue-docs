---
layout: post
title: Vue 3 Getting Started with the Split Button | Syncfusion
description: Set up a Vite Vue 3 project and integrate the Syncfusion Vue Split Button using the Composition API or Options API.
...
# Vue 3 Getting Started with the Split Button
...
## Add Vue SplitButton packages

To install the SplitButton packages, use the following command:
...
## Adding Vue SplitButton component

The SplitButton code should be added in the **src/App.vue** file.
