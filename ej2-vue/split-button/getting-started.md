---
layout: post
title: Getting Started with Vue Split Button | Syncfusion
description: Learn how to get started with the Syncfusion Vue Split Button control. Explore setup, features, examples, and customization options.
...
# Getting Started with Vue Split Button
...
## Adding Vue Split Button packages

To install the Split Button package, use the following command:
...
<style>
@import "../node_modules/@syncfusion/ej2-material3-theme/styles/split-button/index.css";
</style>
...
The Split Button code should be added in the **src/App.vue** file.
