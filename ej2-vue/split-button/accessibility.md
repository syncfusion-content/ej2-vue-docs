---
layout: post
title: Accessibility in Vue Split Button | Syncfusion
description: The Vue Split Button meets ADA, Section 508, WCAG 2.2, screen reader, RTL, and keyboard navigation accessibility standards.
...
# Accessibility in Vue Split Button
