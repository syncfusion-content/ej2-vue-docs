---
layout: post
title: Accessibility in Vue Split button component | Syncfusion
description: Learn here all about Accessibility in Syncfusion Vue Split button component of Syncfusion Essential JS 2 and more.
...
# Accessibility in Vue Split button component
...
{% include code-snippet/split-button/default-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "page.domainurl/code-snippet/split-button/default-cs1" %}