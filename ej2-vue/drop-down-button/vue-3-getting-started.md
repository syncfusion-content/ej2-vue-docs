---
layout: post
title: Getting Started with Vue 3 Dropdown Button | Syncfusion
description: Learn how to get started with the Syncfusion Vue 3 Dropdown Button control. Explore setup, features, examples, and customization options.
...
# Getting Started with Vue 3 Dropdown Button
...
## Add Vue DropDownButton packages

To install the DropDownButton packages, use the following command:
...
## Adding Vue DropDownButton component

The DropDownButton code should be added in the **src/App.vue** file.
