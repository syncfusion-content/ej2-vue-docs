...
# Getting Started with Syncfusion<sup style="font-size:70%">&reg;</sup> Floating Action Button Component in Vue 3
...
## Adding Syncfusion<sup style="font-size:70%">&reg;</sup> Vue Floating Action Button Component in the Application
