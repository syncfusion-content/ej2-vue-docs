...
## Add Vue Floating Action Button packages

To install the Floating Action Button packages, use the following command:
...
## Adding Vue Floating Action Button component

The Floating Action Button code should be added in the **src/App.vue** file.
