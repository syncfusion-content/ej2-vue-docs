...
To get started quickly with Vue Chips, check this video:
...
In this article, the `Material3` theme is applied using CSS styles, which are available in installed packages. The necessary `Material3` CSS styles for the Chips component and its dependents were imported into the `<style>` section of the **src/App.vue** file.
...
Follow the below steps to add the Vue Chips component:

1\. First, import and register the Chips component in the `script` section of the **src/App.vue** file.
