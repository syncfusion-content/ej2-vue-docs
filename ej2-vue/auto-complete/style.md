---
layout: post
title: Style in Vue AutoComplete | Syncfusion
description: Customize the Syncfusion Vue AutoComplete appearance using CSS for the wrapper, input, popup, list items, selection, and disabled states.
control: Style 
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
