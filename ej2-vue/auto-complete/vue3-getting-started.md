---
layout: post
title: Getting Started with Vue AutoComplete in Vue 3 | Syncfusion
description: Set up a Vite project and integrate the Syncfusion Vue AutoComplete component in Vue 3 using the Composition API or Options API.
