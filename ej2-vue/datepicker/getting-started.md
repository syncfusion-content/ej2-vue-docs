---
layout: post
title: Getting Started with Vue DatePicker | Syncfusion
description: Step-by-step guide to install, configure, and render the Syncfusion Vue DatePicker component in a Vue 2 project with theme setup.
...
# Getting Started with Vue DatePicker
...
## Adding Vue DatePicker packages

To install the DatePicker package, use the following command:
