---
layout: post
title: Date Format in Vue DatePicker | Syncfusion
description: Set custom date formats in the Syncfusion Vue DatePicker using the format property and accept multiple input formats with inputFormats.
control: Date format
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
