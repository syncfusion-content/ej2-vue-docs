---
layout: post
title: Getting Started with Vue 3 DatePicker | Syncfusion
description: Step-by-step guide to install, configure, and render the Syncfusion Vue DatePicker in a Vue 3 project using Vite and Composition or Options API.
...
# Getting Started with Vue 3 DatePicker
...
## Add Vue DatePicker packages

To install the DatePicker packages, use the following command:
...
## Adding Vue DatePicker component

The DatePicker code should be added in the **src/App.vue** file.
...
The following example demonstrates how to set the value, min and max dates on initializing the DatePicker. Here the DatePicker allows you to select a date within the range from 9th to 15th in the month of May 2017. To know more about range restriction in DatePicker, please refer this [page](./date-range).
