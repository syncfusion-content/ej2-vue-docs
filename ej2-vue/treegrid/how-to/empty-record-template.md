---
layout: post
title: Vue TreeGrid Empty Record Template | Syncfusion
description: Learn how to customize the empty record template in Vue TreeGrid using images, text, and custom content when no data is available to display.
platform: ej2-vue
