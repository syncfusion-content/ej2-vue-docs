...
## Adding Vue Timeline packages

To install the Timeline package, use the following command:
...
<template>
  <ejs-timeline id="timeline">
    <e-items>
      <e-item content='Shipped'></e-item>
      <e-item content='Departed'></e-item>
      <e-item content='Arrived'></e-item>
