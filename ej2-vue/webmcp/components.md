---
layout: post
title: WebMCP Supported Vue Components | Syncfusion
description: Learn about all Syncfusion Vue components with native WebMCP support, their available tools, use cases, and live demo samples.
control: WebMCP
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
...
# WebMCP Supported Syncfusion® Vue Components

WebMCP-enabled Syncfusion® Vue components expose component-specific tools that allow AI agents to interact with UI components through natural language. These tools provide direct access to component APIs for reading data, performing actions, and automating workflows.
 
This page lists the supported WebMCP tools available in each Syncfusion® Vue component.
