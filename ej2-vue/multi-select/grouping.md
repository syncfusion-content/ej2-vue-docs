---
layout: post
title: Grouping in Vue MultiSelect Dropdown | Syncfusion
description: Group Syncfusion Vue MultiSelect Dropdown items into inline or fixed headers by mapping the groupBy field, with dynamic updates on scroll.
control: Grouping 
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
