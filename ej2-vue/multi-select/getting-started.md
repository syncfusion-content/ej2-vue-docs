---
layout: post
title: Getting Started with Vue MultiSelect Dropdown in Vue 2 | Syncfusion
description: Set up a Vue 2 project with Vue-CLI and integrate the Syncfusion Vue MultiSelect Dropdown using the Composition or Options API.
control: MultiSelect
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
...
# Getting Started with Vue MultiSelect Dropdown in Vue 2
