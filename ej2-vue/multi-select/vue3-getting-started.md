---
layout: post
title: Getting Started with Vue MultiSelect Dropdown in Vue 3 | Syncfusion
description: Set up a Vite project and integrate the Syncfusion Vue MultiSelect Dropdown in Vue 3 using the Composition API or Options API.
control: MultiSelect
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
...
# Getting Started with Vue MultiSelect Dropdown in Vue 3
