---
layout: post
title: Getting Started with Vue Calendar | Syncfusion
description: Step-by-step guide to install, configure, and render the Syncfusion Vue Calendar component in a Vue 2 project with theme setup.
...
# Getting Started with Vue Calendar
...
To install the Calendar package, use the following command:
