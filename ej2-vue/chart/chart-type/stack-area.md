---
layout: post
title: Stacked Area Chart in Vue Chart | Syncfusion
...
# Stacked Area Chart in Vue Chart
...
Use the [`border`](https://ej2.syncfusion.com/vue/documentation/api/chart/series#border) property to configure the border width, color, and dasharray of the stacked area series.
