---
layout: post
title: Getting Started with Vue Spinner | Syncfusion
description: Learn how to get started with the Syncfusion Vue Spinner control. Explore setup, features, examples, and customization options.
...
# Getting Started with Vue Spinner
...
## Add Vue Spinner packages

To install the Spinner packages, use the following command:
...
<style>
    @import "../node_modules/@syncfusion/ej2-material3-theme/styles/spinner/index.css";
</style>

{% endhighlight %}
{% endtabs %}

## Adding Vue Spinner component

The Spinner code should be added in the **src/App.vue** file.
