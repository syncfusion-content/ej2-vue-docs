---
layout: post
title: Vue 3 Getting Started with Vue Radio Button | Syncfusion
description: Learn how to get started with the Syncfusion Vue Radio Button in a Vue 3 project using Vite, with setup, theme installation, and adding radio buttons via Composition or Options API.
...
# Vue 3 Getting Started with Vue Radio Button
...
## Add Vue RadioButton packages

To install the RadioButton packages, use the following command:
...
## Adding Vue RadioButton component

The RadioButton code should be added in the **src/App.vue** file.
...
<template>
  <ul>
    <li><ejs-radiobutton label='Option 1' name="options" ></ejs-radiobutton></li>
    <li><ejs-radiobutton label='Option 2' name="options" checked=true></ejs-radiobutton></li>
  </ul>
</template>
