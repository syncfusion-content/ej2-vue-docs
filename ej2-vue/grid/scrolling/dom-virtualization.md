...
To enable DOM virtualization in the Vue Grid, you need to inject the **DomVirtualization** module. This module is responsible for managing the DOM pooling behavior and optimizing the rendering of data to enhance performance.
...
{% include code-snippet/grid/dom-virtualization-massive-cs1/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/grid/dom-virtualization-massive-cs1/app.vue %}
{% endhighlight %}
{% highlight ts tabtitle="datasource.js" %}
{% include code-snippet/grid/dom-virtualization-massive-cs1/datasource.js %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/grid/dom-virtualization-buffer-cs1/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/grid/dom-virtualization-buffer-cs1/app.vue %}
{% endhighlight %}
{% highlight ts tabtitle="datasource.js" %}
{% include code-snippet/grid/dom-virtualization-buffer-cs1/datasource.js %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight html tabtitle="Composition API (~/src/App.vue)" %}
{% include code-snippet/grid/dom-virtual-scroll-cs1/app-composition.vue %}
{% endhighlight %}
{% highlight html tabtitle="Options API (~/src/App.vue)" %}
{% include code-snippet/grid/dom-virtual-scroll-cs1/app.vue %}
{% endhighlight %}
{% endtabs %}
