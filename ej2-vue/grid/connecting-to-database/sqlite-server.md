...
This section describes step by step process how to retrieve data from a SQLite Server using `CustomAdaptor` and bind it to the Vue Data Grid.
...
**4.** Within the `processResponse` method of `CustomAdaptor`, fetch data by calling the **GetOrderData** method.
  ...
  * In this **GetOrderData** method, fetch data from the SQLite Server database using the **SqliteDataReader** class.
