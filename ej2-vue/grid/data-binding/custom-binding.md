---
layout: post
title: Vue Grid Custom Binding | Syncfusion
description: Learn how to perform custom data binding in the Vue Data Grid with remote data sources and server‑side data operations.
...
# Custom Data Binding in Vue Data Grid
...
The [Data Grid](https://www.syncfusion.com/vue-components/vue-data-grid) component offers a range of powerful features such as **paging**, **grouping**, **sorting**, and **filtering**. These actions trigger the [dataStateChange](https://ej2.syncfusion.com/vue/documentation/api/grid/index-default#datastatechange) event. CRUD actions such as **Create**, **Read**, **Update**, and **Delete** trigger the [dataSourceChanged](https://ej2.syncfusion.com/vue/documentation/api/grid/index-default#datasourcechanged) event. These events provide an opportunity to manage and manipulate data according to user interactions.
...
> The `dataStateChange` event is not triggered during the initial rendering of the Grid. 

## Perform data operations and CRUD

The Data Grid supports data operations such as filtering, sorting, grouping, searching, and CRUD actions for efficient data management.
...
By default, the Syncfusion Data Grid component exports only the records available on the current page. However, the Data Grid component allows exporting all records, including those from multiple pages, by configuring the [pdfExportProperties](https://ej2.syncfusion.com/vue/documentation/api/grid/pdfExportProperties) and [excelExportProperties](https://ej2.syncfusion.com/vue/documentation/api/grid/excelExportProperties).
...
The Data Grid component enables inclusion of custom parameters in data requests. This feature proves particularly useful when providing additional information to the server for enhanced processing capabilities.

By utilizing the [query](https://ej2.syncfusion.com/vue/documentation/api/grid/index-default#query) property of the grid along with the `addParams` method of the Query class, custom parameters can be incorporated into data requests for every grid action.
