---
layout: post
title: Vue Grid Row Spanning | Syncfusion
description: Learn how to implement row spanning in Vue Data Grid using Syncfusion. Merge cells across rows, configure rowspan behavior, and create rich data layouts.
