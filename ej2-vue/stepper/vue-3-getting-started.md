...
# Getting Started with Syncfusion<sup style="font-size:70%">&reg;</sup> Stepper Component in Vue 3
...
## Adding Syncfusion<sup style="font-size:70%">&reg;</sup> Vue Stepper component
