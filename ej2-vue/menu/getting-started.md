---
layout: post
title: Getting Started with Vue Menu Bar | Syncfusion
...
# Getting Started with Vue Menu Bar

This article provides a step-by-step guide for setting up a Vue 2 project using [Vue-CLI](https://cli.vuejs.org) and integrating the Syncfusion<sup style="font-size:70%">&reg;</sup> Vue Menu component
...
## Adding Vue Menu packages

To install the Menu package, use the following command:
