...
description: Learn how to get started with the Syncfusion Vue Badge control. Explore setup, features, examples, and customization options.
...
## Adding Vue Badge packages

To install the Badge package, use the following command:
