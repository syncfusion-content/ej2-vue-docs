<template>
  <div id="container">
    <div class="frame">
      ...
      <ejs-button id="repeat-btn" :enableRepeat="true" :repeatDelay="repeatDelay" :repeatInterval="repeatInterval"
        :disabled="isDisabled" @clicked="onClicked">
        Hold Me
      </ejs-button>
...
const repeatDelay = ref(400);
const repeatInterval = ref(100);
