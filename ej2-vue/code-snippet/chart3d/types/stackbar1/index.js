...
new Vue({
  ...
  template: `
    <div id="app">
        ...
        <e-chart3d-series :dataSource='seriesData1' type='StackingBar' xName='x' yName='y' name='America' > </e-chart3d-series>
          <e-chart3d-series :dataSource='seriesData2' type='StackingBar' xName='x' yName='y' name='Canada' > </e-chart3d-series>
          <e-chart3d-series :dataSource='seriesData3' type='StackingBar' xName='x' yName='y' name='France' > </e-chart3d-series>
          <e-chart3d-series :dataSource='seriesData4' type='StackingBar' xName='x' yName='y' name='Germany' > </e-chart3d-series>
      </e-chart3d-series-collection>
        </ejs-chart3d>
    </div>
`,
