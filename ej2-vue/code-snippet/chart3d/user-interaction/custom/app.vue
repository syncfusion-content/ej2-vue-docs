    ...
    <div id="app">
        <ejs-chart3d id="container" :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis' :title='title' :wallColor='wallColor' 
            ...
            <e-chart3d-series-collection>
                ...
                <e-chart3d-series :dataSource='seriesData' type='Column' xName='country' yName='silver' name='Silver' legendShape='SeriesType'></e-chart3d-series>
                <e-chart3d-series :dataSource='seriesData' type='Column' xName='country' yName='bronze' name='Bronze' legendShape='Rectangle'></e-chart3d-series>
            </e-chart3d-series-collection>
        </ejs-chart3d>
    </div>
</template>
