...
import Vue from "vue";
import { Chart3DPlugin, Category3D, ColumnSeries3D, Legend3D, Highlight3D, Selection3D } from "@syncfusion/ej2-vue-charts";
  ...
  template: `
    <div id="app">
      <ejs-chart3d id="container" :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis' :title='title' :wallColor='wallColor' 
        :enableRotation='enableRotation' :rotation='rotation' :tilt='tilt' :depth='depth' :legendSettings='legendSettings' selectionMode='Series'>
