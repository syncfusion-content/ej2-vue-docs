...
import Vue from "vue";
import { Chart3DPlugin, Category3D, ColumnSeries3D, Selection3D, Legend3D, Highlight3D } from "@syncfusion/ej2-vue-charts";
...
new Vue({
  ...
  template: `
    <div id="app">
        <ejs-chart3d id="container" :primaryXAxis='primaryXAxis' :title='title' selectionMode='Cluster'
