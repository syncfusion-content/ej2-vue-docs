...
import Vue from "vue";
import { Chart3DPlugin, ColumnSeries3D, DateTime3D, Logarithmic3D } from "@syncfusion/ej2-vue-charts";
...
new Vue({
  ...
  template: `
    <div id="app">
      <ejs-chart3d id="container" :primaryXAxis="primaryXAxis" :primaryYAxis="primaryYAxis" :wallColor='wallColor' :enableRotation='enableRotation' 
