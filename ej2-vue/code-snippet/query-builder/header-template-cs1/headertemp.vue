                ...
                return {
                    template : Vue.component('headerTemplate', {
                        ...
                        `<div class="e-groupheader">
                            <button  v-if="data.notValue !== undefined" class='e-cb-wrapper'>
                             <ejs-checkbox :id="notID" label='not' :checked="data.notValue" :change="onChange"></ejs-checkbox>
                            </button>
