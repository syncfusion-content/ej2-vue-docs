...
import { QueryBuilderComponent as EjsQuerybuilder, QueryLibrary, QueryBuilder } from "@syncfusion/ej2-vue-querybuilder";
...
const getSqlClick = () => {
    dialog.value.content = JSON.stringify(querybuilder.value.ej2Instances.getParameterizedNamedSql(querybuilder.value.ej2Instances.getRules()), null, 2);
    dialog.value.show();
};
