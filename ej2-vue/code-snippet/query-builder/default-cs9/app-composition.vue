...
const addRule = function() {
   querybuilder.value.ej2Instances.addRules([{'label': 'City','field': 'City','type': 'string','operator': 'equal','value': 'US'}], 'group0');
};

const addGroup = function() {
    querybuilder.value.ej2Instances.addGroups([{'condition': 'and','rules': [{'label': 'First Name','field': 'FirstName','type': 'string','operator': 'startswith','value': 'v' }]}], 'group0');
};

const deleteGroup = function() {
    querybuilder.value.ej2Instances.deleteGroups(['group1']);
};
