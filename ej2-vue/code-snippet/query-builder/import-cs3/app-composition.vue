<template>
    <div class="control-section">
        <div class="col-lg-12 querybuilder-control">
            ...
            <ejs-button cssClass="e-qb-button" :isPrimary="true" v-on:click="getMongoClick">Set MongoDB Rules</ejs-button>
        </div>
    </div>
</template>
<script setup>
...
const getMongoClick = function() {
    querybuilder.value.ej2Instances.setMongoQuery('{"$and":[{"TaskID":1001},{ "$or":[{"Category":{"$regex":"Order"}}]}]}');
};
