...
import { MapsComponent as EjsMaps, MapsTooltip, Marker, PdfExport, LayerDirective as ELayer, LayersDirective as ELayers } from '@syncfusion/ej2-vue-maps';
...
provide('maps',  [Marker, MapsTooltip, PdfExport]);
