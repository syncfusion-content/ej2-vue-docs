...
import { MapsComponent as EjsMaps, Polygon, MapsTooltip, LayersDirective as ELayers, LayerDirective as ELayer } from '@syncfusion/ej2-vue-maps';
...
const polygonSettings = {
    ...
    polygons: [{
        tooltipTemplate: '<div style="width:200px;border: 2px solid #000;padding: 10px;background-color:white;color:black;font-weight:bold;font-size:15px;"> Country Name : Saudi Arabia</div>',
        points: [
...
provide('maps',  [Polygon, MapsTooltip]);
