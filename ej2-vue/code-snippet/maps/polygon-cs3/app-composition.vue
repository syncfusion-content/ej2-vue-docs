...
import { MapsComponent as EjsMaps, Polygon, Highlight, Selection, LayerDirective as ELayer, LayersDirective as ELayers } from '@syncfusion/ej2-vue-maps';
...
provide('maps',  [Polygon, Highlight, Selection]);
