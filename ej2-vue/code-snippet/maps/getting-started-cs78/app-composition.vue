...
import { MapsComponent as EjsMaps, MapsTooltip, Marker, ImageExport, LayerDirective as ELayer, LayersDirective as ELayers} from '@syncfusion/ej2-vue-maps';
import { world_map } from './world-map.js';

const shapeData = world_map;
const shapeSettings = { fill: 'lightgrey', border: { color: 'black', width: 0.1 } };
...
provide('maps',  [Marker, MapsTooltip, ImageExport]);
