  ...
  <div id='container'>
    <div id="default" style="padding-top:20px">
      <div class='row' style="float:left">
        ...
        <div>
          <ejs-dropdownlist id="headerPosition" ref='headerPosition' :dataSource='headerData' :change='positionChange'
            :value='placeValue' :fields='placeFields'></ejs-dropdownlist>
        </div>
      </div>
      <div class='row' style="float:right">
        <label> Mode </label>
        <div>
          <ejs-dropdownlist id="Mode" ref='mode' :dataSource='modeData' :change='modeChange' :value='value'
...
const modeData = [{ id: 'scrollable', mode: 'Scrollable' }, { id: 'popup', mode: 'Popup' }];
const headerData = [{ id: 'top', position: 'Top' }, { id: 'bottom', position: 'Bottom' }, { id: 'left', position: 'Left' }, { id: 'right', position: 'Right' }];
const fields = { text: 'mode', value: 'id' };
const placeFields = { text: 'position', value: 'id' };
const value = 'scrollable';
const placeValue = 'top';
