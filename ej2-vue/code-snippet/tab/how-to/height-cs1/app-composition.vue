  ...
  <div id="app">
    <div style='padding-top: 25px'>
      <div class='row'>
        ...
        <div class="col-xs-6 col-sm-6 col-lg-6 col-md-6">
          <div class='custom_drop'><ejs-dropdownlist id='contentHeight' ref="contentHeight" :change='onChange' index='1'
              :dataSource='heightData'></ejs-dropdownlist></div>
        </div>
      </div>
      <div style='padding-top: 25px'>
...
const heightData = ['None', 'Content', 'Fill', 'Auto'];

const onChange = () => {
  var tabObj = element.value.ej2Instances;
  var ddlobj = contentHeight.value.ej2Instances;
