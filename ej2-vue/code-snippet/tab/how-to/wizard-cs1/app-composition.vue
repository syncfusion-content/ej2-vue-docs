<template>
    <div class="col-lg-12 control-section e-tab-section">
        <div class="e-sample-resize-container" id="dialog_target">
                ...
                <div class="responsive-align">
                    <div class='row'>
                        <div class="col-xs-6 col-sm-6 col-lg-6 col-md-6 search-item">
                            <ejs-dropdownlist id="startPoint" width="100%" :dataSource='cities'
                                :fields='autoCompleteFields' floatLabelType='Auto'
                                placeholder='From'></ejs-dropdownlist>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-lg-6 col-md-6 search-item">
                            <ejs-dropdownlist id="endPoint" width="100%" :dataSource='cities'
                                :fields='autoCompleteFields' floatLabelType='Auto' placeholder='To'></ejs-dropdownlist>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-lg-6 col-md-6 search-item">
                            <ejs-datepicker id="date" width='100%' placeholder='Journey Date' floatLabelType='Auto'
                                :min='dateMin' :max='dateMax' :focus='showDate'></ejs-datepicker>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-lg-6 col-md-6 search-item">
                            <ejs-dropdownlist id="quota" :dataSource='quotas' placeholder='Ticket type'
                    ...
                    <table id="passenger-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <ejs-numerictextbox id='pass_age1' showSpinButton=false min=1 max=100 value=18
                                        format=n0></ejs-numerictextbox>
                                </td>
                                <td>
                                    <ejs-dropdownlist id='pass_gender1' :dataSource='gender' text="Male"
                                        :fields='fields'></ejs-dropdownlist>
                                </td>
                                <td>
                                    <ejs-dropdownlist id='pass_berth1' :dataSource='berths' placeholder="Optional"
                                        :fields='fields'></ejs-dropdownlist>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <ejs-numerictextbox showSpinButton=false min=1 max=100 value=18
                                        format=n0></ejs-numerictextbox>
                                </td>
                                <td>
                                    <ejs-dropdownlist id='pass_gender2' :dataSource='gender' text="Male"
                                        :fields='fields'></ejs-dropdownlist>
                                </td>
                                <td>
                                    <ejs-dropdownlist id='pass_berth2' :dataSource='berths' placeholder="Optional"
                                        :fields='fields'></ejs-dropdownlist>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <ejs-dropdownlist id='pass_gender3' :dataSource='gender' text="Male"
                                        :fields='fields'></ejs-dropdownlist>
                                </td>
                                <td>
                                    <ejs-dropdownlist id='pass_berth3' :dataSource='berths' placeholder="Optional"
                                        :fields='fields'></ejs-dropdownlist>
                                </td>
                            </tr>
                        </tbody>
            ...
            <div>
                <ejs-dialog id='alertDialog' header='Success' width=250 isModal=true showCloseIcon=true
                    content='Your payment successfully processed' target='#dialog_target' :created='dlgCreated'
...
const dateMin = new Date(new Date().getTime());
const dateMax = new Date(new Date(new Date().getTime() + 60 * 24 * 60 * 60 * 1000));
const quotas = [
...
const headerText0 = { 'text': 'New Booking' };
const headerText1 = { 'text': 'Train List' };
const headerText2 = { 'text': 'Add Passenger' };
const headerText3 = { 'text': 'Make Payment' };

const showDate = () => {
    var journeyDate = document.getElementById("date").ej2_instances[0];
    journeyDate.show();
};
const btnClicked = (args) => {
