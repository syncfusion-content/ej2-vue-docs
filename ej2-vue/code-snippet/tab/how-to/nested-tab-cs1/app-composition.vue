<template>
  <div id="app">
    <ejs-tab ref='element' :selected="handleSelectEvent" :created="handleCreatedEvent">
      <e-tabitems>
...
const headerText0 = { text: 'USA' };
const headerText1 = { text: 'France' };
const headerText2 = { text: 'Australia' };
const content0 = '<div id="usa_tab"></div>';
const content1 = '<div id="france_tab"></div>';
const content2 = '<div id="australia_tab"></div>';
