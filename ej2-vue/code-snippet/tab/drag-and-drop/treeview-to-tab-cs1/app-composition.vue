<template>
    <div id="app">
        <div id='container'>
            ...
            <ejs-treeview ref="treeObj" id="draggableTreeview" :fields="fields" :allowDragAndDrop="true"
                dragArea="#container" cssClass="treeview-external-drop-tab" :nodeDragStop="onNodeDragStop"
...
const onNodeDragStop = (args) => {
    ...
    if (dropElement != null) {
        ...
        tabObject.addTab(newTabItem, dropItemIndex);
        treeObject.removeNodes([args.draggedNode]);
        args.cancel = true;
    } else {
...
const onNodeDrag = function (args) {
