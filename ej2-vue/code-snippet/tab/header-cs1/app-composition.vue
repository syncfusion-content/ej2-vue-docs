        ...
        <div id='content' style="margin: 0px auto">
            <div id="default" style="padding-top:20px;width:250px">
                <div class='row'>
                    ...
                    <div>
                        <ejs-dropdownlist ref='headerStyles' :dataSource='headerData' :change='onChange' :value='value'
...
const fields = { text: 'text', value: 'headerStyle' };
const height = '220px';
const value = 'default';
...
const onChange = () => {
    ...
    var listObj = headerStyles.value.ej2Instances;
    removeStyleClass();
