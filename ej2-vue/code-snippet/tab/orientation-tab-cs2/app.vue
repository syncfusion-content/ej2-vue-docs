...
<div id='container'>
    ...
    <div>
      <ejs-dropdownlist id="dropdown" :dataSource='dropdownData' :change='dropdownChange' index='0' floatLabelType="Always"  placeholder="Select Tab Item using dropdown" :fields='fields' ></ejs-dropdownlist>
    </div>
    <ejs-tab id='element' ref="element" heightAdjustMode='Auto' :selecting='selecting' :selected='selected' height='150px' width='700px'>
        <e-tabitems>
