    ...
    <div id='content' style="margin: 0px auto">
      <div id="default" style="padding-top:20px;width:250px">
        <div class='row'>
          ...
          <div>
            <ejs-dropdownlist ref='iconPosition' :dataSource='iconData' :change='onChange' :value='value'
...
const fields = { text: 'text', value: 'position' };
const height = '220px';
const value = 'left';
const headerText0 = { 'text': 'Twitter', 'iconCss': 'e-twitter' };
const headerText1 = { 'text': 'Facebook', 'iconCss': 'e-facebook' };
const headerText2 = { 'text': 'WhatsApp', 'iconCss': 'e-whatsapp' };

const content0 = 'Twitter is an online social networking service that enables users to send and read short 140-character messages called "tweets".' +
...
const content1 = 'Facebook is an online social networking service headquartered in Menlo Park, California. Its website was launched on February' +
...
const content2 = 'WhatsApp Messenger is a proprietary cross-platform instant messaging client for smartphones that operates under a subscription' +
...
const onChange = () => {
  ...
  var listObj = iconPosition.value.ej2Instances;
  console.log(tabObj);
