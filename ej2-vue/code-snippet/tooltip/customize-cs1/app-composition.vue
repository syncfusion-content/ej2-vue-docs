<template>
  <div id='app'>
    <ejs-tooltip ref='tooltip_1' cssClass="curvetips e-tooltip-css" content="Tooltip arrow customized" target="#target">
      <ejs-tooltip mouseTrail=true :showTipPointer=false content='Disabled tooltip pointer' target='#tooltip'
        cssClass='pointertip e-tooltip-css'>
        <ejs-tooltip position="TopRight" content='Tooltip arrow customized as balloon tip' target='#bubbletip'
          cssClass='bubbletip e-tooltip-css' ref="tooltip_2">
          <div id='container'>
            <div id="customization" class="customTipContainer">
              ...
              <div id="positions">
                <ul>
                  <li>
                    <ejs-radiobutton id='element1' label='TopCenter' name='default' value='TopCenter' checked=true
                      v-on:change='onChange' />
                  </li>
                  <li>
                    <ejs-radiobutton id='element2' label='BottomLeft' name='default' value='BottomLeft'
                      v-on:change='onChange' />
                  </li>
                </ul>
              </div>
            ...
            <div id="balloon" class="customTipContainer">
              ...
              <div id="btn">
                <ul>
                  <li>
                    <ejs-radiobutton id='radio1' label='BottomLeft' name='position' value='BottomLeft'
                      v-on:change='onChanged' />
                  </li>
                  <li>
                    <ejs-radiobutton id='radio2' label='TopRight' name='position' value='TopRight' checked=true
                      v-on:change='onChanged' />
                  </li>
                </ul>
              </div>
...
const tooltip_1 = ref(null);
const tooltip_2 = ref(null);

const onChange = (args) => {
  tooltip_1.value.ej2Instances.position = args.value;
  tooltip_1.value.dataBind();
};
const onChanged = (args) => {
  tooltip_2.value.ej2Instances.position = args.value;
  if (tooltip_2.value.ej2Instances.position == 'BottomLeft') {
    tooltip_2.value.ej2Instances.offsetY = -30;
  } else {
    tooltip_2.value.ej2Instances.offsetY = 0;
  }
  tooltip_2.value.dataBind();
};
</script>
