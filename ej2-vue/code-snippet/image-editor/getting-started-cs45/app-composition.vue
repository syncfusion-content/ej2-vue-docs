<template>
    <div>
        ...
        <ejs-button cssClass="e-img-button" :isPrimary="true" v-on:click="straightenImage">Straighten Image</ejs-button>
    </div>
</template>
...
const straightenImage = () => {
    imageEditorObj.value.ej2Instances.straightenImage(45);
};
