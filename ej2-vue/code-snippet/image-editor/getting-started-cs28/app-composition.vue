<template>
    <div>
        ...
        <ejs-button cssClass="e-img-button" :isPrimary="true" v-on:click="drawClick">Add Text</ejs-button>
        <ejs-button cssClass="e-img-button" :isPrimary="true" v-on:click="btnClick">Delete Text</ejs-button>
    </div>
</template>
