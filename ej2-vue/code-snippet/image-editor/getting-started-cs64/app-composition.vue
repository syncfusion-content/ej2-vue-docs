...
<ejs-button cssClass="e-img-button" :isPrimary="true" v-on:click="loadInvalidImage">Load Invalid Image</ejs-button>
</div>
</template>
...
const loadInvalidImage = () => {
  imageEditorObj.value.ej2Instances.open('flower.jpeg');
};
