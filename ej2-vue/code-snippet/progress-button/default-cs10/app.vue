<template>
  <ejs-progressbutton ref="progressBtn" :content="content" :iconCss="iconCss" :enableProgress="true" :cssClass="cssClass"
      v-on:click="clickHanlder" :end="end"></ejs-progressbutton>
</template>
