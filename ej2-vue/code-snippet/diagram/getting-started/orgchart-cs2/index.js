...
import Vue from 'vue';
import { DiagramPlugin, HierarchicalTree, DataBinding, StackPanel, ImageElement, TextElement } from '@syncfusion/ej2-vue-diagrams';
...
new Vue({
    ...
    template: `
<div id="app">
    <ejs-diagram id="diagram" :width='width' :height='height'  :getNodeDefaults='getNodeDefaults' :getConnectorDefaults='getConnectorDefaults' :setNodeTemplate='setNodeTemplate' :layout='layout' :dataSourceSettings='dataSourceSettings' ></ejs-diagram>
</div>
`,
