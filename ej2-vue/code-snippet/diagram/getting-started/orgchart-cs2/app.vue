<template>
    <div id="app">
        <ejs-diagram id="diagram" :width='width' :height='height'  :getNodeDefaults='getNodeDefaults' :tool='tool' :getConnectorDefaults='getConnectorDefaults' :setNodeTemplate='setNodeTemplate' :layout='layout' :dataSourceSettings='dataSourceSettings' ></ejs-diagram>
    </div>
  </template>
  <script>
    import { DiagramComponent, HierarchicalTree, DataBinding,StackPanel,TextElement, DiagramTools, ImageElement } from '@syncfusion/ej2-vue-diagrams';
