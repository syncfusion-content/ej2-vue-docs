<template>
<div id="app">
   <ejs-button v-on:click="page">Fit To Page </ejs-button>
    <ejs-button v-on:click="fitToWidth">Fit To Width </ejs-button>
    <ejs-button v-on:click="fitToHeight">Fit To Height </ejs-button>
