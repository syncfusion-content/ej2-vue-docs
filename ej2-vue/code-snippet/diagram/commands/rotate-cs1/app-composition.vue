<template>
    <div id="app">
       <button @click="clock">Rotate Clock Wise</button>
        <button @click="antiClock">Rotate AntiClock Wise</button>
...
const clock = function () {
  let diagramInstance = diagramObj.value.ej2Instances;
