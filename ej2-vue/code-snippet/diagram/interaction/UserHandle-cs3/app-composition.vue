<template>
    <div id="app">
        <ejs-diagram id="diagram" :width='width' :height='height' :nodes='nodes' :constraints='constraints'
            :selectedItems='selectedItems'></ejs-diagram>
    </div>
</template>
<script setup>
import { DiagramComponent as EjsDiagram, NodeConstraints, DiagramConstraints, SelectorConstraints } from '@syncfusion/ej2-vue-diagrams';
