...
`,
    ...
    methods: {
        onFixedUserHandleMouseDown: function (event) {
            let diagramInstance;
        ...
        onFixedUserHandleMouseEnter: function (event) {
            if (event.element) {
              event.element.fill = 'red';
              event.element.handleStrokeColor = 'pink';
            }
          },
          onFixedUserHandleMouseUp: function (event) {
            if (event.element) {
              event.element.fill = 'white';
              event.element.handleStrokeColor = 'blue';
            }
          },
          onFixedUserHandleMouseLeave: function (event) {
            if (event.element) {
