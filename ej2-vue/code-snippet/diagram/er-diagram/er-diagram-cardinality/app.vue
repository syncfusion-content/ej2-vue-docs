<template>
    <div id="app">
        <ejs-diagram id="diagram" ref="diagramObj" :width="width" :height="height" :connectors="connectors"></ejs-diagram>
    </div>
</template>

<script>
import { DiagramComponent, ERDiagrams, ERCardinality } from '@syncfusion/ej2-vue-diagrams';
