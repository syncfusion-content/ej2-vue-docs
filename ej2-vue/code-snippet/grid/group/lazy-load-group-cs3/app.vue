<template>
    <div id="app">
         <ejs-grid ref='grid' :dataSource="data" :allowGrouping='true' :enableVirtualScrolling='true' :groupSettings='groupSettings' height='315px'>
            <e-columns>
...
<script>
import { GridComponent, ColumnsDirective, ColumnDirective, Group, LazyLoadGroup, VirtualScroll } from "@syncfusion/ej2-vue-grids";
