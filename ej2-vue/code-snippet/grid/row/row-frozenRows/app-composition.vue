<template>
  <div id="app">
    <div style="display: inline-block; padding: 0px 0 20px 0">
      ...
      <ejs-numerictextbox ref="frozen" min="0" max="5" :validateDecimalOnType="true" decimals="0" format="n" value="2"
        width="100px"></ejs-numerictextbox>
      <ejs-button style="margin-left:10px" v-on:click="frozenRowsFn">Update</ejs-button>
    </div>
    <ejs-grid ref="grid" style="padding: 5px 5px" :dataSource='data' height=315 :frozenRows=2 :allowSelection='false'
      :enableHover='false'>
      <e-columns>
