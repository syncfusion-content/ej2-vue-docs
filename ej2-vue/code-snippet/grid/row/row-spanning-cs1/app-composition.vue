<template>
  <div id="app">
    <ejs-grid :dataSource="telecastData" :enableHover="false" :allowSelection="false" :allowSorting="true" :enableRowSpan="true" :allowTextWrap="true" :textWrapSettings="{ wrapMode: 'Content' }" gridLines="Both" height="450" width="auto" >
      <e-columns>
