<template>
    <div id="app">
        <ejs-grid :dataSource='data' :height='300' :width='width' :gridLines='gridLines' :allowTextWrap='textWrap'
            :queryCellInfo='queryCellInfoEvent'>
            <e-columns>
                <e-column field='EmployeeID' headerText='Employee ID' width='150' textAlign="Right"
