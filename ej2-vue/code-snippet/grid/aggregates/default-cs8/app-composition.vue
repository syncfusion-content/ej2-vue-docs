...
import { GridComponent as EjsGrid, ColumnDirective as EColumn, ColumnsDirective as EColumns, AggregateDirective as EAggregate, AggregatesDirective as EAggregates, Group, Aggregate, Page } from "@syncfusion/ej2-vue-grids";
...
const app = createApp();
  ...
  provide('grid', [Group, Aggregate, Page])
</script>
<style>
