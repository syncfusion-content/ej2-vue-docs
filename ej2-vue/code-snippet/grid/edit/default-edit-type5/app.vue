  ...
  <div id="app">
    <ejs-grid :dataSource='dataGrid' :editSettings='editSettings' :toolbar='toolbar' height='265px'>
      <e-columns>
        ...
        <e-column field="OrderDate" headerText="Order Date" type="date" width="150" format='MM-dd-yyyy' editType= 'datepickeredit' :edit='datePickerParams' :validationRules='orderDateRules'></e-column>      
      </e-columns>
    </ejs-grid>
  </div>
</template>
