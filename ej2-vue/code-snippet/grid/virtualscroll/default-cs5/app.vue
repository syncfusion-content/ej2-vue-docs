<template>
    <div id="app">
        <ejs-grid :dataSource='data' height=300  :enableColumnVirtualization='true' :pageSettings='options' :editSettings='editSettings' :toolbar='toolbar'>
            <e-columns>
