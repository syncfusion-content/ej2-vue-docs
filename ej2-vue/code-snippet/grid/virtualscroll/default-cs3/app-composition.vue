<template>
    <div id="app">
        <ejs-grid :dataSource='griddata' height=300 :enableInfiniteScrolling='true' :pageSettings='options' :infiniteScrollSettings='infiniteOptions'>
            <e-columns>
...
import { GridComponent as EjsGrid, ColumnDirective as EColumn, ColumnsDirective as EColumns, InfiniteScroll } from "@syncfusion/ej2-vue-grids";
