<template>
  <div id="app">
    <ejs-grid ref="grid" id="orderDetails" :dataSource='data' :allowSorting='true' :enablePersistence='true'
      :allowPaging='true' :allowFiltering='true' height='210px' :actionBegin='actionBegin'>
      <e-columns>
