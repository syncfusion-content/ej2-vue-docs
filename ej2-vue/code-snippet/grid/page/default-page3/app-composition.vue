...
const grid = ref(null);
const calculatePageSize=function(args) {
   grid.value.ej2Instances.pageSettings.pageSize =  grid.value.ej2Instances.calculatePageSizeByParentHeight(args.value.toString());
}
  provide('grid',  [Page]);
</script>
<style>
