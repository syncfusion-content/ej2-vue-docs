...
import { GridComponent as EjsGrid, ColumnDirective as EColumn, ColumnsDirective as EColumns, DetailRow,Aggregate} from "@syncfusion/ej2-vue-grids";
...
provide('grid',  [DetailRow,Aggregate]);
</script>
<style>
