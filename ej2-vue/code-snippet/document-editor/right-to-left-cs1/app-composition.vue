<template>
    <div id="app">
        <ejs-documenteditor ref='documenteditor' id='container' pageOutline='#E0E0E0' height="370px"
            style="width: 100%;" :enablePrint='true' :enableSfdtExport='true' :enableSelection='true'
...
onMounted(function () {
    documenteditor.value.ej2Instances.locale = 'ar-AE';
