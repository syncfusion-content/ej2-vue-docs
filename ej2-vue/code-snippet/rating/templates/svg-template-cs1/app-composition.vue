<template>
  <div class='wrap'>
    <ejs-rating id="rating" value="4" :emptyTemplate="emptyTemplate" :fullTemplate="fullTemplate"
...
var emptyTemplate1 = app.component("emptyTemplate", {
...
var fullTemplate1 = app.component("fullTemplate", {
