<template>
  <div class='wrap'>
    <ejs-rating id="rating" value="3" emptyTemplate="<span class='custom-font sf-icon-empty-star'></span>"
      fullTemplate="<span class='custom-font sf-icon-fill-star'></span>"></ejs-rating>
  </div>
</template>
