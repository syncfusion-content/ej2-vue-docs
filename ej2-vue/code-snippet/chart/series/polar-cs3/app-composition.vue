...
import { ChartComponent as EjsChart, SeriesCollectionDirective as ESeriesCollection, SeriesDirective as ESeries, Tooltip, Legend, PolarSeries, Category, LineSeries, RadarSeries } from "@syncfusion/ej2-vue-charts";
...
provide('chart', [Tooltip, Legend, PolarSeries, Category, LineSeries, RadarSeries]);
