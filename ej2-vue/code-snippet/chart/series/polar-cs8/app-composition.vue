...
import { ChartComponent as EjsChart, SeriesCollectionDirective as ESeriesCollection, SeriesDirective as ESeries, PolarSeries, StackingColumnSeries, Category } from "@syncfusion/ej2-vue-charts";
...
provide('chart', [PolarSeries, StackingColumnSeries, Category]);
