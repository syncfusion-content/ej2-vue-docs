<template>
  <div id="app">
    <ejs-chart :title='title' :primaryXAxis='primaryXAxis'>
      <e-series-collection>
        <e-series :dataSource='seriesData' type='StackingArea' xName='x' yName='y' name='Organic' fill="red"
          :border="border" dashArray="5" opacity=0.7> </e-series>
        <e-series :dataSource='seriesData' type='StackingArea' xName='x' yName='y1' name='Fair-trade' fill="yellow"
          :border="border" dashArray="5" opacity=0.7> </e-series>
        <e-series :dataSource='seriesData' type='StackingArea' xName='x' yName='y2' name='Veg Alternatives' fill="green"
          :border="border" dashArray="5" opacity=0.7> </e-series>
        <e-series :dataSource='seriesData' type='StackingArea' xName='x' yName='y3' name='Others' fill="blue"
          :border="border" dashArray="5" opacity=0.7> </e-series>
      </e-series-collection>
    </ejs-chart>
  </div>
...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, StackingAreaSeries, DateTime } from "@syncfusion/ej2-vue-charts";
