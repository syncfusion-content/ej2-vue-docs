<template>
  <div id="app">
    <ejs-chart id="container" :title='title' :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis'>
      <e-series-collection>
        <e-series :dataSource='seriesData' type='SplineRangeArea' xName='x' high='high' low='low' name='England' fill='url(#gradient1)'>
        </e-series>
        <e-series :dataSource='seriesData' type='SplineRangeArea' xName='x' high='high1' low='low1' name='India' fill='url(#gradient2)'>
        </e-series>
      </e-series-collection>
    </ejs-chart>
  </div>
