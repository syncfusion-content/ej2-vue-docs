  ...
  template: `
    <div id="app">
        <ejs-chart id="chartcontainer" :primaryXAxis="primaryXAxis" :primaryYAxis="primaryYAxis" :tooltip="tooltip" :chartArea="chartArea">
            <e-series-collection>
                <e-series :dataSource="seriesData" type="StackingLine" xName="x" yName="y" name="John" :marker="marker" dashArray='5,5'></e-series>
                <e-series :dataSource="seriesData" type="StackingLine" xName="x" yName="y1" name="Peter" :marker="marker" dashArray='5,5'></e-series>
                <e-series :dataSource="seriesData" type="StackingLine" xName="x" yName="y2" name="Steve" :marker="marker" dashArray='5,5'></e-series>
                <e-series :dataSource="seriesData" type="StackingLine" xName="x" yName="y3" name="Charle" :marker="marker" dashArray='5,5'></e-series>
            </e-series-collection>
        </ejs-chart>
    </div>
`,
