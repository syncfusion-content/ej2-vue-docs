...
import { ChartComponent as EjsChart, SeriesCollectionDirective as ESeriesCollection, SeriesDirective as ESeries, SplineSeries, Category, ScatterSeries } from "@syncfusion/ej2-vue-charts";
...
provide('chart', [SplineSeries, Category, ScatterSeries]);
