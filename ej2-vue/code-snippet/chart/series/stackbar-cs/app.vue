<template>
  <div id="app">
    <ejs-chart id="container" :title='title' :primaryXAxis='primaryXAxis'>
      <e-series-collection>
        <e-series :dataSource='seriesData' type='StackingBar' xName='x' yName='y' name='Apple' fill="red"
          :border="border" dashArray="5"> </e-series>
        <e-series :dataSource='seriesData' type='StackingBar' xName='x' yName='y1' name='Orange' fill="yellow"
          :border="border" dashArray="5"> </e-series>
        <e-series :dataSource='seriesData' type='StackingBar' xName='x' yName='y2' name='Wastage' fill="blue"
          :border="border" dashArray="5"> </e-series>
      </e-series-collection>
    </ejs-chart>
  </div>
