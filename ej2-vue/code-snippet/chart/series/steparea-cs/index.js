...
new Vue({
    ...
    <div id="app">
         <ejs-chart id="container" :title='title' :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis'>
            <e-series-collection>
            <e-series :dataSource='seriesData' type='StepArea' xName='x' yName='y' name='India' fill="blue" :border="border" dashArray="5" opacity=0.6 :marker='marker' width=2 step="Right"> </e-series>
            </e-series-collection>
        </ejs-chart>
    </div>
`,
