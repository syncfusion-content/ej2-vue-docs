...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, PolarSeries, StackingAreaSeries } from "@syncfusion/ej2-vue-charts";
...
export default {
  ...
  provide: {
    chart: [PolarSeries, StackingAreaSeries]
  }
};
</script>
<style>
