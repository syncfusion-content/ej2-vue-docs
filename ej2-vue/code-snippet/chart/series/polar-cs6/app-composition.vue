  ...
  <div id="app">
    <ejs-chart id="container" :title='title' :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis'>
      <e-series-collection>
        ...
        <e-series :dataSource='seriesData' type='Polar' xName='x' yName='y2' drawType='StackingArea' name='Veg Alternatives'> </e-series>
      </e-series-collection>
    </ejs-chart>
  </div>
</template>
...
import { ChartComponent as EjsChart, SeriesCollectionDirective as ESeriesCollection, SeriesDirective as ESeries, PolarSeries, StackingAreaSeries } from "@syncfusion/ej2-vue-charts";
...
provide('chart', [PolarSeries, StackingAreaSeries]);
