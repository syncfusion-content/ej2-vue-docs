<template>
  <div id="app">
    <ejs-chart id="container" :title='title' :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis'>
      <e-series-collection>
        <e-series :dataSource='seriesData' type='MultiColoredLine' xName='month' yName='sales' pointColorMapping='color' width=3> </e-series>
      </e-series-collection>
    </ejs-chart>
  </div>
</template>
...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Category, MultiColoredLineSeries } from "@syncfusion/ej2-vue-charts";
