...
import { ChartComponent as EjsChart, SeriesCollectionDirective as ESeriesCollection, SeriesDirective as ESeries, MultiColoredLineSeries } from "@syncfusion/ej2-vue-charts";
...
provide('chart', [MultiColoredLineSeries]);
