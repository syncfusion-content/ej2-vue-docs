<template>
  <div id="app">
    <ejs-chart :title='title' :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis'>
      <e-series-collection>
        <e-series :dataSource='seriesData' type='StackingStepArea' xName='x' yName='y' name='Organic' dashArray='5,5' :border='border'> </e-series>
        <e-series :dataSource='seriesData' type='StackingStepArea' xName='x' yName='y1' name='Fair-trade' dashArray='5,5' :border='border1'> </e-series>
        <e-series :dataSource='seriesData' type='StackingStepArea' xName='x' yName='y2' name='Others' dashArray='5,5' :border='border2'> </e-series>
      </e-series-collection>
    </ejs-chart>
  </div>
</template>
...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, StackingStepAreaSeries, Legend } from "@syncfusion/ej2-vue-charts";
