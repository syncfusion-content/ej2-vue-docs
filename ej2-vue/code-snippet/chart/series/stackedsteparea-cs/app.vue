  ...
  <div id="app">
       <ejs-chart :title='title' :primaryXAxis='primaryXAxis'>
          <e-series-collection>
              ...
              <e-series :dataSource='seriesData' type='StackingStepArea' xName='x' yName='y3' name='Others' fill="blue" :border="border" dashArray="5.5" opacity=0.6 width=2 step="Center"> </e-series>
          </e-series-collection>
      </ejs-chart>
  </div>
</template>
