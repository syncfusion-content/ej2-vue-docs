<template>
  <div id="app">
    <ejs-chart id="container" :title='title' :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis'>
      <e-series-collection>
        <e-series :dataSource='seriesData1' type='RangeColumn' xName='x' low='low' high='high' dashArray='5,5' :border='border'></e-series>
        <e-series :dataSource='seriesData2' type='RangeColumn' xName='x' low='low' high='high' dashArray='5,5' :border='border1'></e-series>
      </e-series-collection>
    </ejs-chart>
  </div>
</template>
