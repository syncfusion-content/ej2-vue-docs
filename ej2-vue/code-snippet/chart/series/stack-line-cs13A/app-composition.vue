...
import { ChartComponent as EjsChart, SeriesCollectionDirective as ESeriesCollection, SeriesDirective as ESeries, Category, Legend, Tooltip, StackingLineSeries, DataLabel } from "@syncfusion/ej2-vue-charts";
...
provide('chart', [Category, Legend, Tooltip, StackingLineSeries, DataLabel]);
