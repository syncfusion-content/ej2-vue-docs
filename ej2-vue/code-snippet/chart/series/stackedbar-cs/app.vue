...
<template>
    <div id="app">
         <ejs-chart id="container" :title='title' :primaryXAxis='primaryXAxis' :primaryYAxis='primaryYAxis'>
            <e-series-collection>
                <e-series :dataSource='seriesData' type='StackingBar100' xName='x' yName='y' name='Apple' fill="red" dashArray="5" :border="border"> </e-series>
                <e-series :dataSource='seriesData' type='StackingBar100' xName='x' yName='y1' name='Orange' fill="green" dashArray="5" :border="border"> </e-series>
                <e-series :dataSource='seriesData' type='StackingBar100' xName='x' yName='y2' name='Wastage' fill="blue" dashArray="5" :border="border"> </e-series>
            </e-series-collection>
        </ejs-chart>
    </div>
</template>
