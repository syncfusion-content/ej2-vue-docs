...
import { ChartComponent as EjsChart, SeriesCollectionDirective as ESeriesCollection, SeriesDirective as ESeries, StackingAreaSeries, DateTime, Legend, DataLabel } from "@syncfusion/ej2-vue-charts";
...
provide('chart', [StackingAreaSeries, DateTime, Legend, DataLabel]);
