...
new Vue({
    ...
    <div id="app">
         <ejs-chart id="container":title='title' :primaryXAxis='primaryXAxis'>
            <e-series-collection>
            <e-series :dataSource="seriesData" type="Column" xName="x" yName="y" name="USA Total" width="2" 
            groupName="USA" columnWidth="0.7" columnSpacing="0.1">
          </e-series>
          <e-series :dataSource="seriesData1" type="Column" xName="x" yName="y" name="USA Gold" width="2" 
            groupName="USA" columnWidth="0.5" columnSpacing="0.1">
          </e-series>
          <e-series :dataSource="seriesData2" type="Column" xName="x" yName="y" name="UK Total" width="2" 
            groupName="UK" columnWidth="0.7" columnSpacing="0.1">
          </e-series>
          <e-series :dataSource="seriesData3" type="Column" xName="x" yName="y" name="UK Gold" width="2" 
          ...
          <e-series :dataSource="seriesData5" type="Column" xName="x" yName="y" name="China Gold" width="2" 
