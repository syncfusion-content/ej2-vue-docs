<template>
  <div id="app">
    <ejs-chart id="container">
      <e-series-collection>
        <e-series :dataSource='seriesData' type='StackingBar' columnFacet='Cylinder' xName='x' yName='y'> </e-series>
        <e-series :dataSource='seriesData' type='StackingBar' columnFacet='Cylinder' xName='x' yName='y1'> </e-series>
        <e-series :dataSource='seriesData' type='StackingBar' columnFacet='Cylinder' xName='x' yName='y2'> </e-series>
      </e-series-collection>
    </ejs-chart>
  </div>
</template>
