...
import { ChartComponent as EjsChart, SeriesCollectionDirective as ESeriesCollection, SeriesDirective as ESeries, StackingBarSeries, Category, Legend, DataLabel } from "@syncfusion/ej2-vue-charts";
...
provide('chart', [StackingBarSeries, Category, Legend, DataLabel]);
