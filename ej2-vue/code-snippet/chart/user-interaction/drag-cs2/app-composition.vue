...
import { ChartComponent as EjsChart, SeriesCollectionDirective as ESeriesCollection, SeriesDirective as ESeries, ScatterSeries, Legend, Selection } from "@syncfusion/ej2-vue-charts";
...
provide('chart', [ScatterSeries, Legend, Selection]);
