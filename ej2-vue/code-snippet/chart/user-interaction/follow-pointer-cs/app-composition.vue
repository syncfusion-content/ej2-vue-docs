...
const tooltip = { enable: true, followPointer: true };
const marker = { visible: true };

const vietnam = vietnamData;
const france = franceData;
const mexico = mexicoData;
...
<style>
  #container {
    height: 350px; /* Keep or adjust as you need */
  }
</style>