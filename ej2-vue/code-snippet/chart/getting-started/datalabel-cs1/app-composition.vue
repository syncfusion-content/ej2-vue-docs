...
import { ChartComponent as EjsChart, SeriesDirective as ESeries, SeriesCollectionDirective as ESeriesCollection, LineSeries, Category, DataLabel, Legend } from "@syncfusion/ej2-vue-charts";
...
provide('chart',  [LineSeries, Category, DataLabel, Legend]);
