...
new Vue({
    ...
    <div id='container' style="height: 350px; width: 650px; margin: 0 auto;">
        <br>
        <button id="summarizeBtn" @click="showPopup">Open Inline AI Assist (de)</button>
        ...
        <ejs-inlineaiassist id='inlineAiAssist' relate-to="#summarizeBtn" popup-width="500px" :prompt-request="onPromptRequest" :response-settings="responseSettings" locale="de" ref="inlineAiAssist"></ejs-inlineaiassist>
    </div>
`,
    data() {
        return {
