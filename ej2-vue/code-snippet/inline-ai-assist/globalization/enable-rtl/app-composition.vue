<template>
    <div id="container" style="height: 350px; width: 650px; margin: 0 auto;">
        ...
        <ejs-inlineaiassist :enable-rtl="true" relate-to="#summarizeBtn" popup-width="500px" :prompt-request="onPromptRequest" :response-settings="responseSettings" ref="inlineAiAssist"></ejs-inlineaiassist>
    </div>
</template>
