        ...
        async onPromptRequest(args) {
            ...
            try {
                ...
                if (reply && reply.response) {
                    ...
                    let i = 0;
                    const responseLength = reply.response.length;
                    stopStreaming = false;
                    while (i < responseLength && !stopStreaming) {
                        lastResponse += reply.response[i++];
                    ...
                    if (this.$refs.inlineAiAssist && this.$refs.inlineAiAssist.addResponse) this.$refs.inlineAiAssist.addResponse(defaultResponse, true);
                }
            } catch (error) {
                if (this.$refs.inlineAiAssist && this.$refs.inlineAiAssist.addResponse) this.$refs.inlineAiAssist.addResponse(defaultResponse, true);
            }
