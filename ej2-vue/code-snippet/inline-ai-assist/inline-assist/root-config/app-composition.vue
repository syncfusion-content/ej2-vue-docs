<template>
  <div id='container' style="height: 350px; width: 650px; margin: 0 auto;">
    ...
    <ejs-inlineaiassist popup-width="650px" css-class="custom-container" popup-height="350px" placeholder="Type your prompt here..." :z-index="4000" relate-to="#summarizeBtn" :prompt-request="onPromptRequest" :response-settings="responseSettings" ref="inlineAiAssist"></ejs-inlineaiassist>
  </div>
</template>
