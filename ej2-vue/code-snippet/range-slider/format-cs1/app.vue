<template>
  <div id="app">
    <div>
      ...
      <ejs-slider id='slider1' :value='value' :tooltip="tooltip" :ticks="ticks" :step="step" :type="type"
        :showButtons="showButtons"> </ejs-slider>
    </div>
    <div class="sliderwrapper">
      <div class='label'>Slider with formatted values</div>
      <ejs-slider id='slider2' :tooltip="wktooltip" :ticks="wkticks" :step="wkstep" :max="wkmax" :min="wkmin"
