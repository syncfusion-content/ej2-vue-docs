...
new Vue({
    ...
    <br />
    <ejs-aiassistview id="aiAssistView" ref="aiassist" :attachmentRemoving="attachmentRemoving" :promptRequest="onPromptRequest" :enableAttachments="true" :attachmentSettings="attachmentSettings" ></ejs-aiassistview>
  </div>
`,
