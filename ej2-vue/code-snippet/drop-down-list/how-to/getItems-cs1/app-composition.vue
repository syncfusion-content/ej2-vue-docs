...
const getItems = function (e) {
  // get items count using getItems method
  console.log("Total items count: " + dropdown.value.getItems().length);
  let element = document.createElement('p');
  element.innerText = "Total items count: " + dropdown.value.getItems().length;
