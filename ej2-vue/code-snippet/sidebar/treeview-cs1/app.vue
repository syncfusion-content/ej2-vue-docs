        ...
        <div class="col-lg-8 control-section">
            <div class='main-header' id='header-section'>
                <ul class='header-list'>
                    <li class='float-left header-style icon-menu' id='hamburger' v-on:click="toggleClick"
                        ref="sidbarToggle"></li>
            ...
            <ejs-sidebar id='sidebar-treeview' :enableDock='enableDock' :width='width' :dockSize='dockSize'
                :mediaQuery='mediaQuery' :target='target' ref="sidebarInstance" :close="close">
                <div class='main-menu'>
                    <div>
                        <ejs-treeview id='main-treeview' :fields='fields' expandOn='Click'
                            ref="treeviewInstance"></ejs-treeview>
                    </div>
                </div>
            </ejs-sidebar>
        ...
        <div class='main-content' id='main-text'>
            <div class='sidebar-content'>
                ...
                <p class='paragraph-content'> This is a graphical aid for visualising and categorising the site,
                    ...
                    Load-on-demand
                    when expanding nodes is available where supported (most graphical browsers), falling back to a
                    full-page reload.
                    MediaWiki-supported caching, aside from squid, has been considered so that unnecessary re-downloads
                    of content are
                    avoided where possible. The complete expanded/collapsed state of the treeview persists across page
                    views in most
                    situations</p>
