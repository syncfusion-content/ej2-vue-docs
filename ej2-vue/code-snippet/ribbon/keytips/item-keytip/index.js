...
import Vue from 'vue';
import { RibbonPlugin, RibbonKeyTip, RibbonItemSize, RibbonGallery, RibbonGroupButtonSelection, RibbonColorPicker } from "@syncfusion/ej2-vue-ribbon";
...
`,
provide: {
  ribbon: [RibbonGallery, RibbonKeyTip, RibbonColorPicker]
},
data: function () {
  return {
