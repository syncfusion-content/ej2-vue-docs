  ...
  <div id="app">
    <div id='container' style="margin:50px auto 0; width:500px;">
        ...
        <ejs-multicolumncombobox id='multicolumn' :dataSource='empData' :fields='fields' placeholder='Select an employee'>
          <e-columns>
              <e-column field='EmpID' :headerTemplate='headerTemplate1' width='90'></e-column>
              <e-column field='Name' :headerTemplate='headerTemplate2' width='160'></e-column>
              <e-column field='Designation' :headerTemplate='headerTemplate3' width='90'></e-column>
              <e-column field='Country' :headerTemplate='headerTemplate4' width='80'></e-column>
          </e-columns>
...
`,
  ...
  data () {
    return {
      ...
      headerTemplate1: '<div class="header"> <span>Employee ID</span> </div>',
      headerTemplate2: '<div class="header"> <span>Employee Name</span> </div>',
      headerTemplate3: '<div class="header"> <span>Designation</span> </div>',
      headerTemplate4: '<div class="header"> <span>Country</span> </div>'
    }
  }
