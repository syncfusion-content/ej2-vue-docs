<template>
  <div id="app">
    <div id='container' style="margin:50px auto 0; width:500px;">
        <br>
        <ejs-multicolumncombobox id='multicolumn' :dataSource='empData' :fields='fields' text='Micheal'>
          <e-columns>
                <e-column field='EmpID' header='Employee ID' width='90' displayAsCheckBox='true'></e-column>
