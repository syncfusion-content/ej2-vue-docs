    ...
    <div>
      <ejs-stockchart
        ...
        <e-stockchart-series-collection>
          <e-stockchart-series :dataSource="seriesData" type="Candle" high='high' low='low' open='open' close='close' volume='volume' :radialGradient="radialGradient"></e-stockchart-series>
        </e-stockchart-series-collection>
      </ejs-stockchart>
    </div>
  </div>
