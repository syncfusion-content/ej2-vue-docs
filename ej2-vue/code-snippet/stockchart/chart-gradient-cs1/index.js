...
import Vue from "vue";
import { StockDetails } from "./datasource.js";
import {
    ...
    <div>
      <ejs-stockchart
        ...
        <e-stockchart-series-collection>
          <e-stockchart-series :dataSource="seriesData" type="Candle" xName="Date" high="High" low="Low" open="Open" close="Close" volume="Volume" :linearGradient="linearGradient"></e-stockchart-series>
        </e-stockchart-series-collection>
      </ejs-stockchart>
    </div>
  </div>
