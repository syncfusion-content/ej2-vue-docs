<template>
  <div class="control-section">
    <div>
      <ejs-stockchart id="stockchartcontainer" :primaryXAxis="primaryXAxis" :primaryYAxis="primaryYAxis" :axes='axes'
        :title="title">
        <e-stockchart-series-collection>
          ...
          <e-stockchart-series :dataSource="seriesData" type="Line" xName='date' yName='close'
            yAxisName='yAxis'></e-stockchart-series>
        </e-stockchart-series-collection>
      </ejs-stockchart>
    </div>
  </div>
