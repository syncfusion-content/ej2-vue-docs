<template>
    <div class="control-section">
        <div id='flat-list'>
            <!-- ListView element -->
            <ejs-listview id='folderCheckbox' ref='listviewInstance' :dataSource='data' :fields='fields'
                sortOrder='Ascending' showHeader=true headerTitle='Mixed Leaf Checkbox Hidden List' showCheckBox=true
                :select='onSelect'>
            </ejs-listview>
        </div>
    </div>
...
const onSelect = (args) => {
    let normalElements = Array.prototype.slice.call(listviewInstance.value.$el.ej2_instances[0].curUL.getElementsByClassName('e-checkbox-hidden'));
