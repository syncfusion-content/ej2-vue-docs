<template>
    <div>
        <div id="text1">
            <input ref='textboxEle' class="e-input" type="text" id="firstInput" placeholder="Filter"
                title="Type in a name" @keyup="onFirstKeyUp" />
        </div>
        ...
        <div id="btn">
            ...
            <ejs-button ref='secondBtnObj' id="secondBtn" :disabled='disabled' @click="secondbtnclick"> &gt;
            </ejs-button>
        ...
        <div id="text2">
            <input ref='textEle' class="e-input" type="text" id="secondInput" placeholder="Filter"
                title="Type in a name" @keyup="onSecondKeyUp" />
        </div>
        <ejs-listview ref='secondListObj' id='list-2' :dataSource='secondListData' :fields='fields'
            sortOrder='Ascending' :select="onSecondListSelect"></ejs-listview>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        secondbtnclick: function () {   //Here, the selected list items are moved to the second list on clicking move button
            ...
            this.$refs.secondListObj.ej2Instances.dataSource = Array.prototype.concat.call(this.$refs.secondListObj.ej2Instances.dataSource, e.data);
            this.$refs.firstListObj.ej2Instances.removeItem(e.item);
            this.firstListData = this.$refs.firstListObj.ej2Instances.dataSource;
            this.secondListData = this.$refs.secondListObj.ej2Instances.dataSource.slice();
            this.onFirstKeyUp();
        ...
        thirdbtnclick: function () {  //Here, the selected list items are moved to the first list on clicking move button
            let e = this.$refs.secondListObj.ej2Instances.getSelectedItems();
            this.$refs.firstListObj.ej2Instances.dataSource = Array.prototype.concat.call(this.$refs.firstListObj.ej2Instances.dataSource, e.data);
            this.$refs.secondListObj.ej2Instances.removeItem(e.item);
            this.secondListData = this.$refs.secondListObj.ej2Instances.dataSource;
            this.firstListData = this.$refs.firstListObj.ej2Instances.dataSource.slice();
            this.onSecondKeyUp();
        ...
        fourthbtnclick: function () {   //Here, all list items are moved to the first list on clicking move all button
            this.$refs.firstListObj.ej2Instances.dataSource = Array.prototype.concat.call(this.$refs.firstListObj.ej2Instances.dataSource, this.$refs.secondListObj.ej2Instances.dataSource);
            this.updateSecondListData();
            this.$refs.secondListObj.ej2Instances.removeMultipleItems(this.$refs.secondListObj.$el.ej2_instances[0].liCollection);
            this.secondListData = this.secondListData.concat(this.$refs.secondListObj.ej2Instances.dataSource);
            this.firstListData = this.$refs.firstListObj.ej2Instances.dataSource.slice();
            this.onSecondKeyUp();
            this.setButtonState();
        },
        ...
        onFirstListSelect: function () {
            this.$refs.secondBtnObj.$el.disabled = false;
        },
        onSecondListSelect: function () {
            this.$refs.thirdBtnObj.$el.disabled = false;
        },
        //Here, filtering is handled using the dataManager for the first list
        onFirstKeyUp: function () {
            ...
            if (!value) {
                this.$refs.firstListObj.ej2Instances.dataSource = this.firstListData.slice();
            } else {
                this.$refs.firstListObj.ej2Instances.dataSource = data;
            }
        },
        //Here, filtering is handled using the dataManager for the second list
        onSecondKeyUp: function () {
            ...
            if (!value) {
                this.$refs.secondListObj.ej2Instances.dataSource = this.secondListData.slice();
            } else {
                this.$refs.secondListObj.ej2Instances.dataSource = data;
            }
        },
        //Here, the state of the button is changed
        setButtonState: function () {
            if (this.$refs.firstListObj.ej2Instances.dataSource.length) {
            ...
            if (this.$refs.secondListObj.ej2Instances.ej2Instances.dataSource.length) {
