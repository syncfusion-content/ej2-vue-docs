...
new Vue({
  ...
  <div class="control-section">
    ...
    <!-- ListView element -->
    <ejs-listview id='List' ref='list' :dataSource='visibleData' cssClass='e-list-template' :template='template' width='400px' height='400px' :scroll="onListScrolled"></ejs-listview>
    </div>
    </div>
  </div>`,
