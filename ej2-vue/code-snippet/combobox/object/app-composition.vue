<template>
    <div id="app">
        <div id="wrapper1">
            <ejs-combobox id='combobox' :dataSource='itemData' :value='value' placeholder='e.g Item 1' :fields='fields'
                :allowObjectBinding='true' :allowFiltering='false' popupHeight="200px"></ejs-combobox>
        </div>
    </div>
</template>
<script setup>
