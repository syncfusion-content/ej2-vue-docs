---
layout: post
title: Getting Started Vue 3 with Vue Sidebar | Syncfusion
description: Learn how to get started with the Syncfusion Vue Sidebar control. Explore setup, features, examples, and customization options.
...
# Getting Started with Vue Sidebar in Vue 3
...
## Add Vue Sidebar packages

To install the Sidebar packages, use the following command:
