---
layout: post
title: Accessibility in Vue Dropdown Tree | Syncfusion
description: Explore WAI-ARIA roles, keyboard navigation, and accessibility attributes used in the Syncfusion Vue Dropdown Tree component.
...
# Accessibility in Vue Dropdown Tree
...
The Dropdown Tree component uses the `listbox` role. Each tree parent item in the popup has the `group` role, and each item in the popup has the **tree item** role. The following ARIA attributes are used in the Dropdown Tree component:
...
The Dropdown Tree functionalities can be interactive by using keyboard shortcuts.
