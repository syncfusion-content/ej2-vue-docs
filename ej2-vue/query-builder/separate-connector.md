---
layout: post
title: Separate Connector in Vue Query Builder UI | Syncfusion
description: Apply different connectors between rules or groups within the same group in the Vue Query Builder UI using enableSeparateConnector.
