---
layout: post
title: Import Export in Vue Query Builder UI | Syncfusion
description: Import and export Vue Query Builder UI rules as JSON, SQL, MongoDB, Inline SQL, Parameter SQL, and Named Parameter SQL query formats.
...
# Import Export in Vue Query Builder UI
...
To learn about how to import and export queries in Vue Query Builder, you can check on this video
...
To initially apply conditions, you can establish the [`rule`](https://ej2.syncfusion.com/vue/documentation/api/query-builder/index-default#rule) by importing a structured JSON object and defining its properties.
...
You can set the conditions from structured JSON object through the [`setRules`](https://ej2.syncfusion.com/vue/documentation/api/query-builder/index-default#setrules) method.
...
You can extract the established conditions in the Query Builder and convert them into a structured JSON object format using the [`getRules`](https://ej2.syncfusion.com/vue/documentation/api/query-builder/index-default#getrules) method. This process enables users to save or transfer the conditions for further use or analysis in other applications or systems that support JSON data.
