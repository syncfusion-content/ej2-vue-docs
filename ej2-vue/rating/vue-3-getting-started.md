---
layout: post
title: Vue 3 getting started with the Speed dial component Rating component | Syncfusion
...
# Getting Started with Syncfusion<sup style="font-size:70%">&reg;</sup> Rating Component in Vue 3
...
This article uses the [Vue Rating component](https://www.syncfusion.com/vue-components/vue-rating) as an example. To use the Vue Rating component in the project, the `@syncfusion/ej2-vue-inputs` package needs to be installed using the following command:

## Adding Syncfusion<sup style="font-size:70%">&reg;</sup> Rating package in the application

Syncfusion<sup style="font-size:70%">&reg;</sup> Vue packages are maintained in the [`npmjs.com`](https://www.npmjs.com/~syncfusionorg) registry. The Rating component will be used in this example. To install it use the following command.
...
## Adding CSS reference for Syncfusion<sup style="font-size:70%">&reg;</sup> Vue Rating component
...
## Adding Syncfusion<sup style="font-size:70%">&reg;</sup> Vue Rating component in the application
