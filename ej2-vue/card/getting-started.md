---
layout: post
title: Getting Started with Vue Card | Syncfusion
description: Set up a Vue 2 project with Vue CLI and integrate the Syncfusion Vue Card component, including CSS themes and basic rendering in App.vue.
