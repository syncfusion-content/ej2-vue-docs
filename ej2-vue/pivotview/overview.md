---
layout: post
title: Overview of Vue Pivot Table | Syncfusion
description: Explore the Vue Pivot Table overview and feature matrix for data analysis, data sources, layouts, performance, exporting, accessibility, and AI integration.
control: Pivot Table
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
...
# Overview of Vue Pivot Table

The Syncfusion<sup style="font-size:70%">&reg;</sup> Vue Pivot Table provides interactive tools for summarizing, organizing, exploring, and presenting multidimensional data. Use the following feature overview to identify the available capabilities, understand where they apply, and open the corresponding user guide topic for configuration details and limitations.

For supported Vue and browser versions, refer to the [system requirements](https://ej2.syncfusion.com/vue/documentation/system-requirements).
...
| Touch interaction and mobile-device support | Built-in | Relational and OLAP | [Accessibility](./accessibility) and [touch support](https://www.syncfusion.com/vue-components/vue-pivot-table#touch-support) |
...
| High Contrast theme support | Configurable | Component UI | [Themes](https://ej2.syncfusion.com/vue/documentation/appearance/theme) |
...
* [Live Pivot Table demos](https://ej2.syncfusion.com/vue/demos/#/tailwind3/pivot-table/overview)
* [Pivot Table API reference](https://ej2.syncfusion.com/vue/documentation/api/pivotview/index-default)
