...
description: Step-by-step example showing how to customize the field-list toggle icon in the Vue Pivot Table by overriding the .pivot-button CSS class with custom content.
