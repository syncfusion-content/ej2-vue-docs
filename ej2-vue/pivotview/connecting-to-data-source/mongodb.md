...
1. In the **App.vue** file, map the Web API URL (`https://localhost:44346/Pivot`) to the Pivot Table using the [url](https://helpej2.syncfusion.com/vue/documentation/api/pivotview/iDataOptions#url) property within the [dataSourceSettings](https://ej2.syncfusion.com/vue/documentation/api/pivotview/dataSourceSettings).
...
1. Configure the Pivot Table report in the **App.vue** file to structure the data retrieved from the MongoDB database.
...
Explore a complete example of the Vue Pivot Table integrated with an ASP.NET Core Web Application to fetch data from a MongoDB database in this [GitHub](https://github.com/SyncfusionExamples/how-to-bind-MongoDB-to-pivot-table) repository.