...
{% youtube "https://www.youtube.com/watch?v=YijduyKXmIo" %}
...
## Adding Syncfusion DateRangePicker package in the application
 ...
 Syncfusion Vue packages are maintained in the [`npmjs.com`](https://www.npmjs.com/~syncfusionorg) registry. The DateRangePicker component will be used in this example. To install it use the following command.
...
Import the needed css styles for the DateRangePicker component along with dependency styles in the `<style>` section of the `src/App.vue` file as follows.
