---
layout: post
title: Getting Started with Vue 3 DateRangePicker | Syncfusion
description: Step-by-step guide to install, configure, and render the Syncfusion Vue DateRangePicker in Vue 3 using Vite and Composition or Options API.
...
# Getting Started with Vue 3 DateRangePicker
...
## Add Vue DateRangePicker packages

To install the DateRangePicker packages, use the following command:
...
## Adding Vue DateRangePicker component

The DateRangePicker code should be added in the **src/App.vue** file.
...
The following example demonstrates how to set the value, min and max dates on initializing the DateRangePicker. Here the DateRangePicker allows you to select a date within the range from 9th to 15th in the month of May 2017. To know more about range restriction in DateRangePicker, please refer this [page](./date-range).
...
<template>
    <div id="app">
        <div class='wrapper'>
            <ejs-daterangepicker :min="data[0].minDate" :max="data[0].maxDate" :value="data[0].dateVal" ></ejs-daterangepicker>
        </div>
  </div>
</template>
...
<template>
    <div id="app">
        <div class='wrapper'>
            <ejs-daterangepicker :min="minDate" :max="maxDate" :value="dateVal" ></ejs-daterangepicker>
        </div>
  </div>
</template>
