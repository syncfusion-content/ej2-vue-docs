---
layout: post
title: Getting Started with Vue DateRangePicker | Syncfusion
description: Step-by-step guide to install, configure, and render the Syncfusion Vue DateRangePicker component in a Vue 2 project with theme setup.
...
# Getting Started with Vue DateRangePicker
...
## Adding Vue DateRangePicker packages

To install the DateRangePicker package, use the following command:
