---
layout: post
title: Getting Started with Vue Quasar | Syncfusion
description: Learn how to set up a Quasar project and integrate Syncfusion Vue UI components using the Composition API.
control: Quasar
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
...
# Getting Started with Syncfusion® Vue Components Using Quasar
