---
layout: post
title: Style in Vue Toolbar | Syncfusion
description: Override the default Vue Toolbar CSS classes to customize the wrapper, items, separators, and scroll buttons for a custom visual appearance.
control: Style 
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
