...
with horizontal scrolling enabled while the commands overflow the available space.

2. **[Popup](./responsive-mode#popup)** : Popup display mode supports to display commands in the popup when the commands overflow
the available space.
...
5. **[RTL Support](https://ej2.syncfusion.com/vue/documentation/api/toolbar/index-default#enablertl)** : The Toolbar supports
right to left alignment.

6. **[Accessibility](./accessibility)** : The Toolbar provides built-in compliance with the [WAI-ARIA](https://www.w3.org/WAI/ARIA/apg/) specifications and it is achieved through attributes.
