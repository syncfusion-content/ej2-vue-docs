...
# Getting Started with Syncfusion Toolbar Component in Vue 3

This section explains how to use Toolbar component in Vue 3 application.
...
4. Adding styles for Toolbar component to render icons
...
![Output](./images/vue3-toolbar-demo.png)

Refer the sample [Vue 3 toolbar getting started](https://github.com/SyncfusionExamples/vue3-toolbar-getting-started)
