---
layout: post
title: Contextual Tabs in Vue Ribbon | Syncfusion
description: Learn how to add contextual tabs in the Vue Ribbon that appear contextually for the selected item, with built-in and custom Ribbon item support.
control: Ribbon
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
