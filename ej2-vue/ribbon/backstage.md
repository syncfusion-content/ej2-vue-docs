---
layout: post
title: Backstage in Vue Ribbon | Syncfusion
description: Learn how to add a Backstage view in the Vue Ribbon to display application-level information and settings like user details and options pages.
control: Ribbon
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
