---
layout: post
title: Items in Vue Ribbon | Syncfusion
description: Learn how to add and configure built-in and custom items in the Vue Ribbon using item types like button, split button, drop-down, and more.
control: Ribbon
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
