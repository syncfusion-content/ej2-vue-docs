---
layout: post
title: Gallery Items in Vue Ribbon | Syncfusion
description: Learn how to add a gallery in the Vue Ribbon to display a collection of related items such as icons, content, or images for quick user actions.
control: Ribbon
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
