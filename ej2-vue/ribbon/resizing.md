---
layout: post
title: Resizing in Vue Ribbon | Syncfusion
description: Learn how the Vue Ribbon resizes elements automatically when space changes, with support for custom resize order in Classic and Simplified modes.
control: Ribbon
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
