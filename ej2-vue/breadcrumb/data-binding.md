---
layout: post
title: Data Binding in Vue Breadcrumb | Syncfusion
description: Bind items to the Vue Breadcrumb using e-breadcrumb-item tag directives or auto-generate them from the current page URL when no url is provided.
...
# Data Binding in Vue Breadcrumb
