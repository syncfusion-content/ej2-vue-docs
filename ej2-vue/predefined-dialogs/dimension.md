---
layout: post
title: Dimension in Vue Predefined Dialogs | Syncfusion
description: Customize Vue Predefined Dialogs dimensions with the height and width properties using pixel or percentage values to set the exact alert and confirm size.
control: Dimension 
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
...
# Dimension in Vue Predefined Dialogs
