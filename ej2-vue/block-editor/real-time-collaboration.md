...
Follow the [Getting Started guide](https://ej2.syncfusion.com/vue/documentation/block-editor/vue-3-getting-started) to create a Vite-based Vue project with the Block Editor component. This ensures you have all required dependencies and the correct project structure before adding collaboration.
