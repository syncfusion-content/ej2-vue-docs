...
Avatar is integrated into the ListView to create contacts-style interfaces. Use the `small` size avatar to match the list-item layout. Letters and images are both supported as avatar content.
