---
layout: post
title: Components in Vue In-place Editor | Syncfusion
description: Learn how the Vue In-place Editor renders built-in and injectable components like TextBox, DatePicker, AutoComplete, and ComboBox via the type property.
control: Components 
platform: ej2-vue
documentation: ug
domainurl: ##DomainURL##
...
# Components in Vue In-place Editor
